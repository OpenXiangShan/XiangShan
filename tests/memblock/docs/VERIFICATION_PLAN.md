...
- segmented LMUL/EMUL cross matrices; all 78 legal ordinary unit-stride,
  strided, indexed-unordered, and indexed-ordered EEW/SEW/LMUL/EMUL
  configurations, all legal whole-register NF/EEW load/store combinations,
...
- segmented LMUL/EMUL multi-uop streams, overlapping indexed operations, and
  architecturally observable ordered-index accesses to a side-effecting
  translated target;
