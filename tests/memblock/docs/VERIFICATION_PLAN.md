...
| Stage-1 Sv39 walk | Bare/Sv39 mode, L2/L1/L0 leaves (1-GiB/2-MiB/4-KiB), invalid/non-leaf, misaligned superpage, permission/PBMT/A-D combinations | Partial; all leaf levels, invalid root, malformed superpage, and U/S, SUM, MXR, missing-A load/store, missing-D store cases execute; non-leaf/PBMT/reserved crosses remain |
| Stage-1 Sv48 walk | Bare/Sv48 mode, L3/L2/L1/L0 leaves (512-GiB/1-GiB/2-MiB/4-KiB), L3 faults, canonicality, permission/PBMT/A-D combinations | Partial; all leaf levels, noncanonical VA, and the same table-driven U/S, SUM, MXR, A/D load/store matrix execute; invalid/PBMT/reserved crosses remain |
