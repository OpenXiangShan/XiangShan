...
| G-stage Sv39x4 walk | 16-KiB root, widened root index, 41-bit GPA, all leaf levels, high-GPA overflow, G-stage permissions | Partial; all leaf levels, high-GPA overflow, permission faults, and 13 invalid/reserved/PBMT/NAPOT encoding cases execute for loads and stores; store-D and valid two-stage PBMT composition remain |
| G-stage Sv48x4 walk | 16-KiB root, widened root index, 50-bit GPA, all leaf levels, high-GPA overflow, G-stage permissions | Partial; all leaf levels, high-GPA overflow, permission faults, and the same 13 encoding cases execute for loads and stores; store-D and valid two-stage PBMT composition remain |
