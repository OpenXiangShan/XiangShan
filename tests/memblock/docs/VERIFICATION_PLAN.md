...
hypervisor family, CMO operation/line state/younger overlap, NC/MMIO direction,
...
coverage. Atomic AMO/LRSC/AMOCAS family and W/D width, CMO operation/line state/
younger-load overlap, Probe/refill overlap, NC/MMIO load/store
...
- wider simultaneous multi-class/multiple-CMO ordering, common random CMO error
  injection, and full-core `fence`/`fence.i` integration (CBO.ZERO and
  ...
  cancellation are covered; translation-fence ordering for global/selective
