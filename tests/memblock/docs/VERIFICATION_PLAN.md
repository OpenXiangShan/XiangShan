...
`ldCancel`/wakeup cause crosses, followed by concurrent Probe overlap and
hardware-prefetch causality; then negative protocol injection. Translation
mode depth itself is no longer
