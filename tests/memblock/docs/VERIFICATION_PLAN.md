...
whole-register NF/EEW matrix and ordinary unit-stride EEW/SEW/LMUL/EMUL
matrix. The next closure work is negative protocol
...
- broader non-unit-stride and segmented LMUL/EMUL cross matrices; all 78 legal
  ordinary unit-stride EEW/SEW/LMUL/EMUL configurations, all legal
...
- broader non-unit-stride LMUL/EMUL multi-uop vector streams and overlapping
  indexed operations beyond the representative ordinary LMUL=2 cases;
