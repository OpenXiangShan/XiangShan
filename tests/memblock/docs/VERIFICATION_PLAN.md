...
| G-stage Sv39x4 walk | 16-KiB root, widened root index, 41-bit GPA, all leaf levels, high-GPA overflow, G-stage permissions | Partial; all leaf levels, high-GPA overflow, load/store permission faults including `D=0`, and 13 invalid/reserved/PBMT/NAPOT encoding cases execute for loads and stores; valid two-stage PBMT composition remains |
| G-stage Sv48x4 walk | 16-KiB root, widened root index, 50-bit GPA, all leaf levels, high-GPA overflow, G-stage permissions | Partial; all leaf levels, high-GPA overflow, load/store permission faults including `D=0`, and the same 13 encoding cases execute for loads and stores; valid two-stage PBMT composition remains |
