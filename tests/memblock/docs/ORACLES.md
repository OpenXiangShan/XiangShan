...
| HLV/HLVX/HSV | Privilege/virtualization/PMP/PMA reference model including SPVP and execute permission | Effective mode, permission cause, final PA, RF/store side effect, and exception metadata. All three operation families execute under every Sv39/Sv48 and Sv39x4/Sv48x4 pair; a five-case PBMT basis covers final PMA/NC/IO and VS-over-G priority, cacheable misaligned HLV.D/HLVX.WU/HSV.D use exact split-data/readback oracles, and M-mode execution crosses SPVP=U/S with physical PMP R/X/W permissions. Physical PMA-device and locked/edge hypervisor PMP crosses remain |
...
| Remaining PMP/PMA matrix | Extend the current hand-calculated TOR/NAPOT cases with fixed-PMA cacheability/atomic classification and locked/edge hypervisor regions | Access allowed/denied, cause, constrained manager requests, and exact region boundary behavior. Data-side TOR/NAPOT, R/W/AMO denial, lock/priority, 4-KiB-grain NA4 WARL behavior, and M-mode HLV/HLVX/HSV using SPVP-selected PMP R/X/W permissions are executable |
