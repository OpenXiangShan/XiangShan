...
the selected boundary before the instruction is issued. The common schema-46
tail currently uses only unit-stride M1 shapes (`EEW=SEW`, `LMUL=EMUL=1`) and
crosses stage-1 Sv39/Sv48, NF2..8, and later/first fault position. A later
