...
for both Sv39/Sv48 and load/store, requires a complete cold load walk followed
by the store path's single AF-leaf reread through the shared PageTableCache,
and forbids DCache/Uncache requests.
