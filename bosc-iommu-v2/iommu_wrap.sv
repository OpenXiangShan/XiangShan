...
module iommu_wrap(
    ...
    //AW ACE-Lite
    input  [3:0]                iommu_slv_awsnoop,
    input  [1:0]                iommu_slv_awdomain,
    input                       iommu_slv_awidunq,
    input  [5:0]                iommu_slv_awatop,
    input                       iommu_slv_awloop,
    ...
    //AR ACE-Lite
    input  [3:0]                iommu_slv_arsnoop,
    input  [1:0]                iommu_slv_ardomain,
    input                       iommu_slv_aridunq,
    input                       iommu_slv_arloop,
    ...
    //R ACE-Lite
    output                      iommu_slv_ridunq,
    output                      iommu_slv_rloop,
    ...
    //B ACE-Lite
    output                      iommu_slv_bidunq,
    output                      iommu_slv_bloop,
    ...
    //AW ACE-Lite
    output [3:0]                iommu_mst_awsnoop,
    output [1:0]                iommu_mst_awdomain,
    output                      iommu_mst_awidunq,
    output [5:0]                iommu_mst_awatop,
    output                      iommu_mst_awloop,
    ...
    //AR ACE-Lite
    output [3:0]                iommu_mst_arsnoop,
    output [1:0]                iommu_mst_ardomain,
    output                      iommu_mst_aridunq,
    output                      iommu_mst_arloop,
    ...
    //R ACE-Lite
    input                       iommu_mst_ridunq,
    input                       iommu_mst_rloop,
    ...
    //B ACE-Lite
    input                       iommu_mst_bidunq,
    input                       iommu_mst_bloop,

    input                       iommu_tr_rvalid_i,
    output                      iommu_tr_rready_o,
    input  [63:0]               iommu_tr_rdata_i,
    input  [7:0]                iommu_tr_rstrb_i,
    input  [7:0]                iommu_tr_rkeep_i,
    input                       iommu_tr_rlast_i,
    input  [3:0]                iommu_tr_rid_i,

    output                      iommu_tr_tvalid_o,
    input                       iommu_tr_tready_i,
    output [63:0]               iommu_tr_tdata_o,
    output [7:0]                iommu_tr_tstrb_o,
    output [7:0]                iommu_tr_tkeep_o,
    output                      iommu_tr_tlast_o,
    output [3:0]                iommu_tr_tid_o,

    //ace5-liteDVM
    input                       iommu_ds_acvalid,
    output                      iommu_ds_acready,
    input  [52-1:0]             iommu_ds_acaddr,
    input  [3:0]                iommu_ds_acvmidext,
    input  [3:0]                iommu_ds_acsnoop,
    input  [2:0]                iommu_ds_acprot,
    output                      iommu_ds_crvalid,
    input                       iommu_ds_crready,
    output [4:0]                iommu_ds_crresp,
    output [1:0]                iommu_ds_ardomain,
    output [3:0]                iommu_ds_arsnoop,
    output [1:0]                iommu_ds_arbar,
    output [5:0]                iommu_ds_awatop,
    output [1:0]                iommu_ds_awdomain,

    output [5:0]                iommu_ds_awid,
...
//=== DEVICE SROUCE SEL {{{
    ...
    logic [3:0]                     src_slv_awsnoop;
    logic [1:0]                     src_slv_awdomain;
    logic                           src_slv_awidunq;
    logic [5:0]                     src_slv_awatop;
    logic                           src_slv_awloop;

    logic [3:0]                     src_slv_arsnoop;
    logic [1:0]                     src_slv_ardomain;
    logic                           src_slv_aridunq;
    logic                           src_slv_arloop;

    logic                           src_slv_ridunq;
    logic                           src_slv_rloop;
    logic                           src_slv_bidunq;
    logic                           src_slv_bloop;
...
/*    logic [3:0]    */    assign src_slv_awsnoop   = device_dma_or_trafficgen ? 4'd0                               : iommu_slv_awsnoop;
/*    logic [1:0]    */    assign src_slv_awdomain  = device_dma_or_trafficgen ? 2'd0                               : iommu_slv_awdomain;
/*    logic          */    assign src_slv_awidunq   = device_dma_or_trafficgen ? 1'd0                               : iommu_slv_awidunq;
/*    logic [5:0]    */    assign src_slv_awatop    = device_dma_or_trafficgen ? 6'd0                               : iommu_slv_awatop;
/*    logic          */    assign src_slv_awloop    = device_dma_or_trafficgen ? 1'd0                               : iommu_slv_awloop;

/*    logic [3:0]    */    assign src_slv_arsnoop   = device_dma_or_trafficgen ? 4'd0                               : iommu_slv_arsnoop;
/*    logic [1:0]    */    assign src_slv_ardomain  = device_dma_or_trafficgen ? 2'd0                               : iommu_slv_ardomain;
/*    logic          */    assign src_slv_aridunq   = device_dma_or_trafficgen ? 1'd0                               : iommu_slv_aridunq;
/*    logic          */    assign src_slv_arloop    = device_dma_or_trafficgen ? 1'd0                               : iommu_slv_arloop;
...
/*    output  [7 :0] */    assign TRAFFIC_M_AXI_0_buser    = device_dma_or_trafficgen ? src_slv_buser       : 'd0;
...
/*    logic          */    assign iommu_slv_ridunq          = ~device_dma_or_trafficgen ? src_slv_ridunq : 'd0;
/*    logic          */    assign iommu_slv_rloop           = ~device_dma_or_trafficgen ? src_slv_rloop  : 'd0;

/*    logic          */    assign iommu_slv_bidunq          = ~device_dma_or_trafficgen ? src_slv_bidunq : 'd0;
/*    logic          */    assign iommu_slv_bloop           = ~device_dma_or_trafficgen ? src_slv_bloop  : 'd0;
...
//=== SYS CFG APB {{{
    ...
    logic                           iommu_test_pslverr_o;
    logic                           iommu_inst_pslverr_o;
    logic                           iommu_inst_pready;
...
assign iommu_test_pready            = 'd1;
assign iommu_pready_o               = iommu_paddr_i[15:12]=='d0 ? iommu_inst_pready :
                                      iommu_paddr_i[15:12]=='d1 ? iommu_test_pready :
                                      iommu_paddr_i[15:12]=='hf ? axi_mon_pready_o  : 1'b0;
assign iommu_pslverr_o              = iommu_paddr_i[15:12]=='d0 ? iommu_inst_pslverr_o :
                                      iommu_paddr_i[15:12]=='d1 ? iommu_test_pslverr_o :
                                      iommu_paddr_i[15:12]=='hf ? axi_mon_pslverr_o : 1'b0;
assign iommu_test_psel              = iommu_psel_i      & (iommu_paddr_i[15:12]=='d1);
assign iommu_inst_psel              = iommu_psel_i      & (iommu_paddr_i[15:12]==0);
assign iommu_test_pslverr_o         ='d0;
...
//=== IOMMU BYPASS SIGNAL AND CONNECTION {{{
    ...
    logic [3:0]                     bypass_slv_awsnoop;
    logic [1:0]                     bypass_slv_awdomain;
    logic                           bypass_slv_awidunq;
    logic [5:0]                     bypass_slv_awatop;
    logic                           bypass_slv_awloop;

    logic [3:0]                     bypass_slv_arsnoop;
    logic [1:0]                     bypass_slv_ardomain;
    logic                           bypass_slv_aridunq;
    logic                           bypass_slv_arloop;

    logic                           bypass_slv_ridunq;
    logic                           bypass_slv_rloop;

    logic                           bypass_slv_bidunq;
    logic                           bypass_slv_bloop;
    ...
    logic [3:0]                     acd_slv_awsnoop;
    logic [1:0]                     acd_slv_awdomain;
    logic                           acd_slv_awidunq;
    logic [5:0]                     acd_slv_awatop;
    logic                           acd_slv_awloop;

    logic [3:0]                     acd_slv_arsnoop;
    logic [1:0]                     acd_slv_ardomain;
    logic                           acd_slv_aridunq;
    logic                           acd_slv_arloop;

    logic                           acd_slv_ridunq;
    logic                           acd_slv_rloop;

    logic                           acd_slv_bidunq;
    logic                           acd_slv_bloop;
    ...
    assign bypass_slv_awsnoop       = src_slv_awsnoop;
    assign bypass_slv_awdomain      = src_slv_awdomain;
    assign bypass_slv_awidunq       = src_slv_awidunq;
    assign bypass_slv_awatop        = src_slv_awatop;
    assign bypass_slv_awloop        = src_slv_awloop;

    assign bypass_slv_arsnoop       = src_slv_arsnoop;
    assign bypass_slv_ardomain      = src_slv_ardomain;
    assign bypass_slv_aridunq       = src_slv_aridunq;
    assign bypass_slv_arloop        = src_slv_arloop;
...
//    assign bypass_slv_buser       = src_slv_buser;
    ...
    logic [63:0]                    acd_slv_awaddr_ext;
    logic [63:0]                    acd_slv_araddr_ext;
    assign acd_slv_awaddr_ext = {24'd0, acd_slv_awaddr};
    assign acd_slv_araddr_ext = {24'd0, acd_slv_araddr};

    assign       aw_mmio_did =  (acd_slv_awaddr_ext>={addr_63_32_start[0], addr_31_0_start[0]} & acd_slv_awaddr_ext<{addr_63_32_end[0], addr_31_0_end[0]}) ? did[0] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[1], addr_31_0_start[1]} & acd_slv_awaddr_ext<{addr_63_32_end[1], addr_31_0_end[1]}) ? did[1] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[2], addr_31_0_start[2]} & acd_slv_awaddr_ext<{addr_63_32_end[2], addr_31_0_end[2]}) ? did[2] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[3], addr_31_0_start[3]} & acd_slv_awaddr_ext<{addr_63_32_end[3], addr_31_0_end[3]}) ? did[3] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[4], addr_31_0_start[4]} & acd_slv_awaddr_ext<{addr_63_32_end[4], addr_31_0_end[4]}) ? did[4] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[5], addr_31_0_start[5]} & acd_slv_awaddr_ext<{addr_63_32_end[5], addr_31_0_end[5]}) ? did[5] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[6], addr_31_0_start[6]} & acd_slv_awaddr_ext<{addr_63_32_end[6], addr_31_0_end[6]}) ? did[6] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[7], addr_31_0_start[7]} & acd_slv_awaddr_ext<{addr_63_32_end[7], addr_31_0_end[7]}) ? did[7] : src_slv_awuser[31:8];

    assign       aw_mmio_pid =  (acd_slv_awaddr_ext>={addr_63_32_start[0], addr_31_0_start[0]} & acd_slv_awaddr_ext<{addr_63_32_end[0], addr_31_0_end[0]}) ? pid[0] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[1], addr_31_0_start[1]} & acd_slv_awaddr_ext<{addr_63_32_end[1], addr_31_0_end[1]}) ? pid[1] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[2], addr_31_0_start[2]} & acd_slv_awaddr_ext<{addr_63_32_end[2], addr_31_0_end[2]}) ? pid[2] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[3], addr_31_0_start[3]} & acd_slv_awaddr_ext<{addr_63_32_end[3], addr_31_0_end[3]}) ? pid[3] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[4], addr_31_0_start[4]} & acd_slv_awaddr_ext<{addr_63_32_end[4], addr_31_0_end[4]}) ? pid[4] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[5], addr_31_0_start[5]} & acd_slv_awaddr_ext<{addr_63_32_end[5], addr_31_0_end[5]}) ? pid[5] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[6], addr_31_0_start[6]} & acd_slv_awaddr_ext<{addr_63_32_end[6], addr_31_0_end[6]}) ? pid[6] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[7], addr_31_0_start[7]} & acd_slv_awaddr_ext<{addr_63_32_end[7], addr_31_0_end[7]}) ? pid[7] : src_slv_awuser[51:32];

    assign       aw_mmio_pid_v =(acd_slv_awaddr_ext>={addr_63_32_start[0], addr_31_0_start[0]} & acd_slv_awaddr_ext<{addr_63_32_end[0], addr_31_0_end[0]}) ? pid_v[0] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[1], addr_31_0_start[1]} & acd_slv_awaddr_ext<{addr_63_32_end[1], addr_31_0_end[1]}) ? pid_v[1] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[2], addr_31_0_start[2]} & acd_slv_awaddr_ext<{addr_63_32_end[2], addr_31_0_end[2]}) ? pid_v[2] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[3], addr_31_0_start[3]} & acd_slv_awaddr_ext<{addr_63_32_end[3], addr_31_0_end[3]}) ? pid_v[3] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[4], addr_31_0_start[4]} & acd_slv_awaddr_ext<{addr_63_32_end[4], addr_31_0_end[4]}) ? pid_v[4] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[5], addr_31_0_start[5]} & acd_slv_awaddr_ext<{addr_63_32_end[5], addr_31_0_end[5]}) ? pid_v[5] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[6], addr_31_0_start[6]} & acd_slv_awaddr_ext<{addr_63_32_end[6], addr_31_0_end[6]}) ? pid_v[6] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[7], addr_31_0_start[7]} & acd_slv_awaddr_ext<{addr_63_32_end[7], addr_31_0_end[7]}) ? pid_v[7] : src_slv_awuser[52];

    assign      aw_mmio_transed=(acd_slv_awaddr_ext>={addr_63_32_start[0], addr_31_0_start[0]} & acd_slv_awaddr_ext<{addr_63_32_end[0], addr_31_0_end[0]}) ? transed[0] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[1], addr_31_0_start[1]} & acd_slv_awaddr_ext<{addr_63_32_end[1], addr_31_0_end[1]}) ? transed[1] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[2], addr_31_0_start[2]} & acd_slv_awaddr_ext<{addr_63_32_end[2], addr_31_0_end[2]}) ? transed[2] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[3], addr_31_0_start[3]} & acd_slv_awaddr_ext<{addr_63_32_end[3], addr_31_0_end[3]}) ? transed[3] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[4], addr_31_0_start[4]} & acd_slv_awaddr_ext<{addr_63_32_end[4], addr_31_0_end[4]}) ? transed[4] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[5], addr_31_0_start[5]} & acd_slv_awaddr_ext<{addr_63_32_end[5], addr_31_0_end[5]}) ? transed[5] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[6], addr_31_0_start[6]} & acd_slv_awaddr_ext<{addr_63_32_end[6], addr_31_0_end[6]}) ? transed[6] :
                                (acd_slv_awaddr_ext>={addr_63_32_start[7], addr_31_0_start[7]} & acd_slv_awaddr_ext<{addr_63_32_end[7], addr_31_0_end[7]}) ? transed[7] : src_slv_awuser[53];


    assign       ar_mmio_did =  (acd_slv_araddr_ext>={addr_63_32_start[0], addr_31_0_start[0]} & acd_slv_araddr_ext<{addr_63_32_end[0], addr_31_0_end[0]}) ? did[0] :
                                (acd_slv_araddr_ext>={addr_63_32_start[1], addr_31_0_start[1]} & acd_slv_araddr_ext<{addr_63_32_end[1], addr_31_0_end[1]}) ? did[1] :
                                (acd_slv_araddr_ext>={addr_63_32_start[2], addr_31_0_start[2]} & acd_slv_araddr_ext<{addr_63_32_end[2], addr_31_0_end[2]}) ? did[2] :
                                (acd_slv_araddr_ext>={addr_63_32_start[3], addr_31_0_start[3]} & acd_slv_araddr_ext<{addr_63_32_end[3], addr_31_0_end[3]}) ? did[3] :
                                (acd_slv_araddr_ext>={addr_63_32_start[4], addr_31_0_start[4]} & acd_slv_araddr_ext<{addr_63_32_end[4], addr_31_0_end[4]}) ? did[4] :
                                (acd_slv_araddr_ext>={addr_63_32_start[5], addr_31_0_start[5]} & acd_slv_araddr_ext<{addr_63_32_end[5], addr_31_0_end[5]}) ? did[5] :
                                (acd_slv_araddr_ext>={addr_63_32_start[6], addr_31_0_start[6]} & acd_slv_araddr_ext<{addr_63_32_end[6], addr_31_0_end[6]}) ? did[6] :
                                (acd_slv_araddr_ext>={addr_63_32_start[7], addr_31_0_start[7]} & acd_slv_araddr_ext<{addr_63_32_end[7], addr_31_0_end[7]}) ? did[7] : src_slv_aruser[31:8];

    assign       ar_mmio_pid =  (acd_slv_araddr_ext>={addr_63_32_start[0], addr_31_0_start[0]} & acd_slv_araddr_ext<{addr_63_32_end[0], addr_31_0_end[0]}) ? pid[0] :
                                (acd_slv_araddr_ext>={addr_63_32_start[1], addr_31_0_start[1]} & acd_slv_araddr_ext<{addr_63_32_end[1], addr_31_0_end[1]}) ? pid[1] :
                                (acd_slv_araddr_ext>={addr_63_32_start[2], addr_31_0_start[2]} & acd_slv_araddr_ext<{addr_63_32_end[2], addr_31_0_end[2]}) ? pid[2] :
                                (acd_slv_araddr_ext>={addr_63_32_start[3], addr_31_0_start[3]} & acd_slv_araddr_ext<{addr_63_32_end[3], addr_31_0_end[3]}) ? pid[3] :
                                (acd_slv_araddr_ext>={addr_63_32_start[4], addr_31_0_start[4]} & acd_slv_araddr_ext<{addr_63_32_end[4], addr_31_0_end[4]}) ? pid[4] :
                                (acd_slv_araddr_ext>={addr_63_32_start[5], addr_31_0_start[5]} & acd_slv_araddr_ext<{addr_63_32_end[5], addr_31_0_end[5]}) ? pid[5] :
                                (acd_slv_araddr_ext>={addr_63_32_start[6], addr_31_0_start[6]} & acd_slv_araddr_ext<{addr_63_32_end[6], addr_31_0_end[6]}) ? pid[6] :
                                (acd_slv_araddr_ext>={addr_63_32_start[7], addr_31_0_start[7]} & acd_slv_araddr_ext<{addr_63_32_end[7], addr_31_0_end[7]}) ? pid[7] : src_slv_aruser[51:32];

    assign       ar_mmio_pid_v =(acd_slv_araddr_ext>={addr_63_32_start[0], addr_31_0_start[0]} & acd_slv_araddr_ext<{addr_63_32_end[0], addr_31_0_end[0]}) ? pid_v[0] :
                                (acd_slv_araddr_ext>={addr_63_32_start[1], addr_31_0_start[1]} & acd_slv_araddr_ext<{addr_63_32_end[1], addr_31_0_end[1]}) ? pid_v[1] :
                                (acd_slv_araddr_ext>={addr_63_32_start[2], addr_31_0_start[2]} & acd_slv_araddr_ext<{addr_63_32_end[2], addr_31_0_end[2]}) ? pid_v[2] :
                                (acd_slv_araddr_ext>={addr_63_32_start[3], addr_31_0_start[3]} & acd_slv_araddr_ext<{addr_63_32_end[3], addr_31_0_end[3]}) ? pid_v[3] :
                                (acd_slv_araddr_ext>={addr_63_32_start[4], addr_31_0_start[4]} & acd_slv_araddr_ext<{addr_63_32_end[4], addr_31_0_end[4]}) ? pid_v[4] :
                                (acd_slv_araddr_ext>={addr_63_32_start[5], addr_31_0_start[5]} & acd_slv_araddr_ext<{addr_63_32_end[5], addr_31_0_end[5]}) ? pid_v[5] :
                                (acd_slv_araddr_ext>={addr_63_32_start[6], addr_31_0_start[6]} & acd_slv_araddr_ext<{addr_63_32_end[6], addr_31_0_end[6]}) ? pid_v[6] :
                                (acd_slv_araddr_ext>={addr_63_32_start[7], addr_31_0_start[7]} & acd_slv_araddr_ext<{addr_63_32_end[7], addr_31_0_end[7]}) ? pid_v[7] : src_slv_aruser[52];

    assign      ar_mmio_transed=(acd_slv_araddr_ext>={addr_63_32_start[0], addr_31_0_start[0]} & acd_slv_araddr_ext<{addr_63_32_end[0], addr_31_0_end[0]}) ? transed[0] :
                                (acd_slv_araddr_ext>={addr_63_32_start[1], addr_31_0_start[1]} & acd_slv_araddr_ext<{addr_63_32_end[1], addr_31_0_end[1]}) ? transed[1] :
                                (acd_slv_araddr_ext>={addr_63_32_start[2], addr_31_0_start[2]} & acd_slv_araddr_ext<{addr_63_32_end[2], addr_31_0_end[2]}) ? transed[2] :
                                (acd_slv_araddr_ext>={addr_63_32_start[3], addr_31_0_start[3]} & acd_slv_araddr_ext<{addr_63_32_end[3], addr_31_0_end[3]}) ? transed[3] :
                                (acd_slv_araddr_ext>={addr_63_32_start[4], addr_31_0_start[4]} & acd_slv_araddr_ext<{addr_63_32_end[4], addr_31_0_end[4]}) ? transed[4] :
                                (acd_slv_araddr_ext>={addr_63_32_start[5], addr_31_0_start[5]} & acd_slv_araddr_ext<{addr_63_32_end[5], addr_31_0_end[5]}) ? transed[5] :
                                (acd_slv_araddr_ext>={addr_63_32_start[6], addr_31_0_start[6]} & acd_slv_araddr_ext<{addr_63_32_end[6], addr_31_0_end[6]}) ? transed[6] :
                                (acd_slv_araddr_ext>={addr_63_32_start[7], addr_31_0_start[7]} & acd_slv_araddr_ext<{addr_63_32_end[7], addr_31_0_end[7]}) ? transed[7] : src_slv_aruser[53];
    ...
    assign acd_slv_awsnoop          = src_slv_awsnoop;
    assign acd_slv_awdomain         = src_slv_awdomain;
    assign acd_slv_awidunq          = src_slv_awidunq;
    assign acd_slv_awatop           = src_slv_awatop;
    assign acd_slv_awloop           = src_slv_awloop;

    assign acd_slv_arsnoop          = src_slv_arsnoop;
    assign acd_slv_ardomain         = src_slv_ardomain;
    assign acd_slv_aridunq          = src_slv_aridunq;
    assign acd_slv_arloop           = src_slv_arloop;
...
//    assign acd_slv_buser                = src_slv_buser;
    ...
    assign src_slv_ridunq           = hw_bypass_en ? bypass_slv_ridunq    : acd_slv_ridunq;
    assign src_slv_rloop            = hw_bypass_en ? bypass_slv_rloop     : acd_slv_rloop;

    assign src_slv_bidunq           = hw_bypass_en ? bypass_slv_bidunq    : acd_slv_bidunq;
    assign src_slv_bloop            = hw_bypass_en ? bypass_slv_bloop     : acd_slv_bloop;
    ...
    logic [3:0]                     acd_mst_awsnoop;
    logic [1:0]                     acd_mst_awdomain;
    logic                           acd_mst_awidunq;
    logic [5:0]                     acd_mst_awatop;
    logic                           acd_mst_awloop;
    logic [3:0]                     acd_mst_arsnoop;
    logic [1:0]                     acd_mst_ardomain;
    logic                           acd_mst_aridunq;
    logic                           acd_mst_arloop;
    logic                           acd_mst_ridunq;
    logic                           acd_mst_rloop;
    logic                           acd_mst_bidunq;
    logic                           acd_mst_bloop;
    ...
    assign iommu_mst_awuser         = hw_bypass_en ? bypass_slv_awuser[7:0]: acd_mst_awuser;
    ...
    assign iommu_mst_aruser         = hw_bypass_en ? bypass_slv_aruser[7:0]: acd_mst_aruser;
    ...
    assign iommu_mst_awsnoop        = hw_bypass_en ? bypass_slv_awsnoop    : acd_mst_awsnoop;
    assign iommu_mst_awdomain       = hw_bypass_en ? bypass_slv_awdomain   : acd_mst_awdomain;
    assign iommu_mst_awidunq        = hw_bypass_en ? bypass_slv_awidunq    : acd_mst_awidunq;
    assign iommu_mst_awatop         = hw_bypass_en ? bypass_slv_awatop     : acd_mst_awatop;
    assign iommu_mst_awloop         = hw_bypass_en ? bypass_slv_awloop     : acd_mst_awloop;

    assign iommu_mst_arsnoop        = hw_bypass_en ? bypass_slv_arsnoop    : acd_mst_arsnoop;
    assign iommu_mst_ardomain       = hw_bypass_en ? bypass_slv_ardomain   : acd_mst_ardomain;
    assign iommu_mst_aridunq        = hw_bypass_en ? bypass_slv_aridunq    : acd_mst_aridunq;
    assign iommu_mst_arloop         = hw_bypass_en ? bypass_slv_arloop     : acd_mst_arloop;
...
//    assign iommu_mst_buser          = hw_bypass_en ? bypass_slv_buser      : acd_mst_buser;
    ...
    assign bypass_slv_ridunq        = iommu_mst_ridunq;
    assign bypass_slv_rloop         = iommu_mst_rloop ;

    assign bypass_slv_bidunq        = iommu_mst_bidunq;
    assign bypass_slv_bloop         = iommu_mst_bloop;
    ...
    assign acd_mst_ridunq       = iommu_mst_ridunq;
    assign acd_mst_rloop        = iommu_mst_rloop ;
    assign acd_mst_bidunq       = iommu_mst_bidunq;
    assign acd_mst_bloop        = iommu_mst_bloop ;
...
/*    output [0 :0] */         assign MONITOR_AXI_0_wvalid    = monitor_src_sel ? iommu_mst_wvalid        : src_slv_wvalid;
    ...
    iommu_axi_mon #(
    /*parameter */ .BUS_ADDR_WIDTH             (40                             ), // = 64,
    /*parameter */ .BUS_DATA_WIDTH             (256                            ), // = 128,
    /*parameter */ .BUS_SIZE_WIDTH             (3                              ), // = 3,
    /*parameter */ .BUS_ID_WIDTH               (10                             ), // = 8,
    /*parameter */ .BUS_USER_WIDTH             (8                              ), // = 8,
    /*parameter */ .AWRAM_IDX_WIDTH            (6                              ), // = 7,
    /*parameter */ .ARRAM_IDX_WIDTH            (6                              ), // = 7,
    /*parameter */ .WRAM_IDX_WIDTH             (8                              ), // = 7,
    /*parameter */ .BRAM_IDX_WIDTH             (6                              ), // = 7,
    /*parameter */ .RRAM_IDX_WIDTH             (8                              ), // = 7,
    ...
    /*input  logic [BUS_USER_WIDTH-1:0]                 */  .slv_awuser_i                   (src_slv_awuser[7:0]            ),
    ...
    /*input  logic [ BUS_USER_WIDTH-1:0]                */  .slv_aruser_i                   (src_slv_aruser[7:0]            ),
...
`ifdef CONFIG_RISCV_IOMMU_BOSC_V2_LITE
,
    .WBUF_FIFO_TYPE                 (1                              ),//= 1'b1, // 0:FF type, 1:RAM type
    .SLV_AW_REGSLICE                (1                              ),//= iommu_acd_pkg::SLV_AW_REGSLICE,
    .SLV_W_REGSLICE                 (1                              ),//= iommu_acd_pkg::SLV_W_REGSLICE,
    .SLV_AR_REGSLICE                (1                              ),//= iommu_acd_pkg::SLV_AR_REGSLICE,
    .SLV_R_REGSLICE                 (1                              ),//= iommu_acd_pkg::SLV_R_REGSLICE,
    .SLV_B_REGSLICE                 (1                              ),//= iommu_acd_pkg::SLV_B_REGSLICE,
    .MST_AW_REGSLICE                (1                              ),//= iommu_acd_pkg::MST_AW_REGSLICE,
    .MST_W_REGSLICE                 (1                              ),//= iommu_acd_pkg::MST_W_REGSLICE,
    .MST_AR_REGSLICE                (1                              ),//= iommu_acd_pkg::MST_AR_REGSLICE,
    .MST_R_REGSLICE                 (1                              ),//= iommu_acd_pkg::MST_R_REGSLICE,
    .MST_B_REGSLICE                 (1                              ),//= iommu_acd_pkg::MST_B_REGSLICE,
    .BUS_INFLY_TOKEN_WIDTH          (8                              ),//= iommu_acd_pkg::BUS_INFLY_TOKEN_WIDTH,
    .BUS_ADDR_WIDTH                 (64                             ),//= 64,                               // should never change to any other value
    .BUS_LOOP_WIDTH                 (1                              ),//= iommu_acd_pkg::BUS_LOOP_WIDTH,

    .INV_IDX_WIDTH                  (1                              ),//= iommu_acd_pkg::INV_IDX_WIDTH,     // should not bigger than 4
    .FAULT_TOKEN_WIDTH              (5                              ),//= iommu_acd_pkg::FAULT_TOKEN_WIDTH, // should not bigger than 12
    .PTW_IDX_WIDTH                  (4                              ),//= iommu_acd_pkg::PTW_IDX_WIDTH,     // should not bigger than 8
    .TRANS_QIDX_WIDTH               (3                              ),//= iommu_acd_pkg::TRANS_QIDX_WIDTH,
    .TRANS_QUEUE_DEPTH              (8                              ),//= 2**TRANS_QIDX_WIDTH,
    .TLB_QIDX_WIDTH                 (3                              ),//= iommu_acd_pkg::TLB_QIDX_WIDTH,    // should not bigger than PTW_IDX_WIDTH-1
    .TLB_QUEUE_DEPTH                (8                              ),//= 2**TLB_QIDX_WIDTH,
    .MICRO_TLB_IDX_WIDTH            (5                              ),//= iommu_acd_pkg::MICRO_TLB_IDX_WIDTH,

    .CABIN_LKP_IDX_WIDTH            (2                              ),
    .CABIN_UPD_IDX_WIDTH            (2                              ),
    .CABIN_INV_IDX_WIDTH            (2                              ),
    .BANK_4K_IDX_WIDTH              (2                              ),
    .BANK_2M_IDX_WIDTH              (1                              ),
    .BANK_1G_IDX_WIDTH              (1                              ),
    .BANK_0T_IDX_WIDTH              (1                              ),
    .BANK_4K_SET_IDX_WIDTH          (4                              ),
    .BANK_2M_SET_IDX_WIDTH          (1                              ),
    .BANK_1G_SET_IDX_WIDTH          (1                              ),
    .BANK_0T_SET_IDX_WIDTH          (1                              ),
    .BANK_4K_WAY_IDX_WIDTH          (3                              ),
    .BANK_2M_WAY_IDX_WIDTH          (1                              ),
    .BANK_1G_WAY_IDX_WIDTH          (1                              ),
    .BANK_0T_WAY_IDX_WIDTH          (1                              ),
    .SPARE_PARAM                    (0)//= 0
    `endif /* CONFIG_RISCV_IOMMU_BOSC_V2_LITE */
)
u0_iommu_acd
(
    .clk                            (iommu_clk                      ),
    ...
    .slv_awsnoop_i                  (acd_slv_awsnoop              ),
    .slv_awdomain_i                 (acd_slv_awdomain             ),
    .slv_awidunq_i                  (acd_slv_awidunq              ),
    .slv_awatop_i                   (acd_slv_awatop               ),
    .slv_awloop_i                   (acd_slv_awloop               ),
    ...
    .slv_bidunq_o                   (acd_slv_bidunq               ),
    .slv_bloop_o                    (acd_slv_bloop                ),
    ...
    .slv_arsnoop_i                  (acd_slv_arsnoop              ),
    .slv_ardomain_i                 (acd_slv_ardomain             ),
    .slv_aridunq_i                  (acd_slv_aridunq              ),
    .slv_arloop_i                   (acd_slv_arloop               ),
    ...
    .slv_ridunq_o                   (acd_slv_ridunq               ),
    .slv_rloop_o                    (acd_slv_rloop                ),
    ...
    .mst_awsnoop_o                  (acd_mst_awsnoop              ),
    .mst_awdomain_o                 (acd_mst_awdomain             ),
    .mst_awidunq_o                  (acd_mst_awidunq              ),
    .mst_awatop_o                   (acd_mst_awatop               ),
    .mst_awloop_o                   (acd_mst_awloop               ),
    ...
    .mst_bidunq_i                   (acd_mst_bidunq               ),
    .mst_bloop_i                    (acd_mst_bloop                ),
    ...
    .mst_arsnoop_o                  (acd_mst_arsnoop              ),
    .mst_ardomain_o                 (acd_mst_ardomain             ),
    .mst_aridunq_o                  (acd_mst_aridunq              ),
    .mst_arloop_o                   (acd_mst_arloop               ),
    ...
    .mst_ridunq_i                   (acd_mst_ridunq               ),
    .mst_rloop_i                    (acd_mst_rloop                ),
...
`ifdef CONFIG_RISCV_IOMMU_BOSC_V2_LITE
    ,
    .INV_IDX_WIDTH                  (2                              ),
    .DDTC_INV_IDX_WIDTH             (2                              ),
    .DDTC_TLB_QIDX_WIDTH            (1                              ),
    .DDTC_MICRO_TLB_IDX_WIDTH       (3                              ),
    .DDTC_CABIN_LKP_IDX_WIDTH       (1                              ),
    .DDTC_CABIN_UPD_IDX_WIDTH       (1                              ),
    .DDTC_CABIN_INV_IDX_WIDTH       (1                              ),
    .DDTC_BANK_L0_IDX_WIDTH         (1                              ),
    .DDTC_BANK_L1_IDX_WIDTH         (1                              ),
    .DDTC_BANK_L2_IDX_WIDTH         (1                              ),
    .DDTC_BANK_L0_SET_IDX_WIDTH     (4                              ),
    .DDTC_BANK_L1_SET_IDX_WIDTH     (2                              ),
    .DDTC_BANK_L2_SET_IDX_WIDTH     (1                              ),
    .DDTC_BANK_L0_WAY_IDX_WIDTH     (1                              ),
    .DDTC_BANK_L1_WAY_IDX_WIDTH     (1                              ),
    .DDTC_BANK_L2_WAY_IDX_WIDTH     (1                              ),

    .PDTC_TLB_QIDX_WIDTH            (1                              ),
    .PDTC_MICRO_TLB_IDX_WIDTH       (3                              ),
    .PDTC_CABIN_LKP_IDX_WIDTH       (1                              ),
    .PDTC_CABIN_UPD_IDX_WIDTH       (1                              ),
    .PDTC_CABIN_INV_IDX_WIDTH       (1                              ),
    .PDTC_BANK_L0_IDX_WIDTH         (1                              ),
    .PDTC_BANK_L1_IDX_WIDTH         (1                              ),
    .PDTC_BANK_L2_IDX_WIDTH         (1                              ),
    .PDTC_BANK_L0_SET_IDX_WIDTH     (4                              ),
    .PDTC_BANK_L1_SET_IDX_WIDTH     (2                              ),
    .PDTC_BANK_L2_SET_IDX_WIDTH     (1                              ),
    .PDTC_BANK_L0_WAY_IDX_WIDTH     (1                              ),
    .PDTC_BANK_L1_WAY_IDX_WIDTH     (1                              ),
    .PDTC_BANK_L2_WAY_IDX_WIDTH     (1                              ),

    .S1PTC_TLB_QIDX_WIDTH           (1                              ),
    .S1PTC_MICRO_TLB_IDX_WIDTH      (5                              ),
    .S1PTC_CABIN_LKP_IDX_WIDTH      (1                              ),
    .S1PTC_CABIN_UPD_IDX_WIDTH      (1                              ),
    .S1PTC_CABIN_INV_IDX_WIDTH      (1                              ),
    .S1PTC_BANK_L0_IDX_WIDTH        (1                              ),
    .S1PTC_BANK_L1_IDX_WIDTH        (1                              ),
    .S1PTC_BANK_L2_IDX_WIDTH        (1                              ),
    .S1PTC_BANK_L3_IDX_WIDTH        (1                              ),
    .S1PTC_BANK_L4_IDX_WIDTH        (1                              ),
    .S1PTC_BANK_L0_SET_IDX_WIDTH    (4                              ),
    .S1PTC_BANK_L1_SET_IDX_WIDTH    (2                              ),
    .S1PTC_BANK_L2_SET_IDX_WIDTH    (1                              ),
    .S1PTC_BANK_L3_SET_IDX_WIDTH    (1                              ),
    .S1PTC_BANK_L4_SET_IDX_WIDTH    (1                              ),
    .S1PTC_BANK_L0_WAY_IDX_WIDTH    (3                              ),
    .S1PTC_BANK_L1_WAY_IDX_WIDTH    (1                              ),
    .S1PTC_BANK_L2_WAY_IDX_WIDTH    (1                              ),
    .S1PTC_BANK_L3_WAY_IDX_WIDTH    (1                              ),
    .S1PTC_BANK_L4_WAY_IDX_WIDTH    (1                              ),

    .S2PTC_TLB_QIDX_WIDTH           (1                              ),
    .S2PTC_MICRO_TLB_IDX_WIDTH      (5                              ),
    .S2PTC_CABIN_LKP_IDX_WIDTH      (1                              ),
    .S2PTC_CABIN_UPD_IDX_WIDTH      (1                              ),
    .S2PTC_CABIN_INV_IDX_WIDTH      (1                              ),
    .S2PTC_BANK_L0_IDX_WIDTH        (1                              ),
    .S2PTC_BANK_L1_IDX_WIDTH        (1                              ),
    .S2PTC_BANK_L2_IDX_WIDTH        (1                              ),
    .S2PTC_BANK_L3_IDX_WIDTH        (1                              ),
    .S2PTC_BANK_L4_IDX_WIDTH        (1                              ),
    .S2PTC_BANK_L0_SET_IDX_WIDTH    (4                              ),
    .S2PTC_BANK_L1_SET_IDX_WIDTH    (2                              ),
    .S2PTC_BANK_L2_SET_IDX_WIDTH    (1                              ),
    .S2PTC_BANK_L3_SET_IDX_WIDTH    (1                              ),
    .S2PTC_BANK_L4_SET_IDX_WIDTH    (1                              ),
    .S2PTC_BANK_L0_WAY_IDX_WIDTH    (3                              ),
    .S2PTC_BANK_L1_WAY_IDX_WIDTH    (1                              ),
    .S2PTC_BANK_L2_WAY_IDX_WIDTH    (1                              ),
    .S2PTC_BANK_L3_WAY_IDX_WIDTH    (1                              ),
    .S2PTC_BANK_L4_WAY_IDX_WIDTH    (1)
`endif /* CONFIG_RISCV_IOMMU_BOSC_V2_LITE */
)
u1_iommu_atd
(
...
//    .iommu_prdata_o               (iommu_prdata_o               ),
    ...
    .iommu_pready_o                 (iommu_inst_pready              ),
    .iommu_pslverr_o                (iommu_inst_pslverr_o           ),
    ...
    //input from ats
    .atd_r2t_rvalid_i               (iommu_tr_rvalid_i              ),
    .atd_r2t_rready_o               (iommu_tr_rready_o              ),
    .atd_r2t_rdata_i                (iommu_tr_rdata_i               ),
    .atd_r2t_rstrb_i                (iommu_tr_rstrb_i               ),
    .atd_r2t_rkeep_i                (iommu_tr_rkeep_i               ),
    .atd_r2t_rlast_i                (iommu_tr_rlast_i               ),
    .atd_r2t_rid_i                  (iommu_tr_rid_i                 ),

    //output to ats
    .atd_t2r_tvalid_o               (iommu_tr_tvalid_o              ),
    .atd_t2r_tready_i               (iommu_tr_tready_i              ),
    .atd_t2r_tdata_o                (iommu_tr_tdata_o               ),
    .atd_t2r_tstrb_o                (iommu_tr_tstrb_o               ),
    .atd_t2r_tkeep_o                (iommu_tr_tkeep_o               ),
    .atd_t2r_tlast_o                (iommu_tr_tlast_o               ),
    .atd_t2r_tid_o                  (iommu_tr_tid_o                 ),

    //ace5-liteDVM
    .atd_ace5_acvalid               (iommu_ds_acvalid               ),
    .atd_ace5_acready               (iommu_ds_acready               ),
    .atd_ace5_acaddr                (iommu_ds_acaddr                ),
    .atd_ace5_acvmidext             (iommu_ds_acvmidext             ),
    .atd_ace5_acsnoop               (iommu_ds_acsnoop               ),
    .atd_ace5_acprot                (iommu_ds_acprot                ),
    .atd_ace5_crvalid               (iommu_ds_crvalid               ),
    .atd_ace5_crready               (iommu_ds_crready               ),
    .atd_ace5_crresp                (iommu_ds_crresp                ),

    .atd_ace5_ardomain              (iommu_ds_ardomain              ),
    .atd_ace5_arsnoop               (iommu_ds_arsnoop               ),
    .atd_ace5_arbar                 (iommu_ds_arbar                 ),
    .atd_ace5_awatop                (iommu_ds_awatop                ),
    .atd_ace5_awdomain              (iommu_ds_awdomain              ),

    .atd_ace5_arvalid               (iommu_ds_arvalid               ),
    .atd_ace5_arready               (iommu_ds_arready               ),
    .atd_ace5_arid                  (iommu_ds_arid                  ),
    .atd_ace5_araddr                (iommu_ds_araddr                ),
    .atd_ace5_arlen                 (iommu_ds_arlen                 ),
    .atd_ace5_arsize                (iommu_ds_arsize                ),
    .atd_ace5_arburst               (iommu_ds_arburst               ),
    .atd_ace5_arlock                (iommu_ds_arlock                ),
    .atd_ace5_arcache               (iommu_ds_arcache               ),
    .atd_ace5_arprot                (iommu_ds_arprot                ),
    .atd_ace5_arqos                 (iommu_ds_arqos                 ),
    .atd_ace5_rvalid                (iommu_ds_rvalid                ),
    .atd_ace5_rready                (iommu_ds_rready                ),
    .atd_ace5_rlast                 (iommu_ds_rlast                 ),
    .atd_ace5_rid                   (iommu_ds_rid                   ),
    .atd_ace5_rresp                 (iommu_ds_rresp                 ),
    .atd_ace5_rdata                 (iommu_ds_rdata                 ),
    .atd_ace5_awvalid               (iommu_ds_awvalid               ),
    .atd_ace5_awready               (iommu_ds_awready               ),
    .atd_ace5_awid                  (iommu_ds_awid                  ),
    .atd_ace5_awaddr                (iommu_ds_awaddr                ),
    .atd_ace5_awlen                 (iommu_ds_awlen                 ),
    .atd_ace5_awsize                (iommu_ds_awsize                ),
    .atd_ace5_awburst               (iommu_ds_awburst               ),
    .atd_ace5_awlock                (iommu_ds_awlock                ),
    .atd_ace5_awcache               (iommu_ds_awcache               ),
    .atd_ace5_awprot                (iommu_ds_awprot                ),
    .atd_ace5_awqos                 (iommu_ds_awqos                 ),
    .atd_ace5_wvalid                (iommu_ds_wvalid                ),
    .atd_ace5_wready                (iommu_ds_wready                ),
    .atd_ace5_wlast                 (iommu_ds_wlast                 ),
    .atd_ace5_wstrb                 (iommu_ds_wstrb                 ),
    .atd_ace5_wdata                 (iommu_ds_wdata                 ),
    .atd_ace5_bvalid                (iommu_ds_bvalid                ),
    .atd_ace5_bready                (iommu_ds_bready                ),
    .atd_ace5_bid                   (iommu_ds_bid                   ),
    .atd_ace5_bresp                 (iommu_ds_bresp)
);
