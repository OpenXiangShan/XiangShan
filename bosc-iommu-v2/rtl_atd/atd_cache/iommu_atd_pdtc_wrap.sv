...
//{{{ IO
    ...
    input  logic [19:0]                                 lookup_req_process_id_i,
    ...
    output logic [127:0]                                lookup_ack_o,
    // update
    ...
    input  logic [127:0]                                update_req_i,
    input  logic [23:0]                                 update_req_device_id_i,
    input  logic [19:0]                                 update_req_process_id_i,
...
//=== Declare === {{{
    ...
    localparam TECC_WIDTH   = (ECC_ENABLE==0) ? 0 : 6;
    localparam NLDECC_WIDTH = (ECC_ENABLE==0) ? 0 : 6;
    localparam LDECC_WIDTH  = (ECC_ENABLE==0) ? 0 : 7;
...
//=== LOOKUP {{{
    ...
    assign tc_lookup_req_i.process_id       = lookup_req_process_id_i;
...
//=== UPDATE {{{
    ...
    assign tc_update_req_i.process_id       = update_req_process_id_i;
    assign tc_update_req_i.fsc_mode         = update_req_lvl_i=='d0 ? update_req_i[64+63:64+60] : 'd0;
    assign tc_update_req_i.fsc_ppn          = update_req_lvl_i=='d0 ? update_req_i[64+43:64+0]  : update_req_i[53:10];
    assign tc_update_req_i.PSCID            = update_req_lvl_i=='d0 ? update_req_i[31:12]       : 'd0;
    assign tc_update_req_i.SUM              = update_req_lvl_i=='d0 ? update_req_i[2]           : 'd0;
    assign tc_update_req_i.ENS              = update_req_lvl_i=='d0 ? update_req_i[1]           : 'd0;
...
//=== Inst === {{{
    iommu_atd_dtc_top #(
    /*parameter */              .CACHE_TYPE                 (1'b1                   ), // = 0, // 0:DDTC, 1:PDTC
