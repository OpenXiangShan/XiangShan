...
//    input  logic [19:0]                                 lookup_req_pscid_i,
    input  logic [63:12]                                lookup_req_gpa_i,
...
//    input  logic [19:0]                                 update_req_pscid_i,
    ...
    input  logic [63:12]                                update_req_gpa_i,
...
//=== LOOKUP {{{
    ...
    assign tc_lookup_req_i.addr         = lookup_req_gpa_i;
...
//        assign update_pte_position = (update_req_lvl_i=='d4) ? {1'b0, update_req_gpa_i[50:48]} :
//                                     (update_req_lvl_i=='d3) ? {1'b0, update_req_gpa_i[41:39]} :
//                                     (update_req_lvl_i=='d2) ? {1'b0, update_req_gpa_i[32:30]} :
//                                     (update_req_lvl_i=='d1) ? (csr_fctl_gxl_i==1'b1 ? {1'b0, update_req_gpa_i[24:22]} : {1'b0, update_req_gpa_i[23:21]}) :
//                                     (update_req_lvl_i=='d0) ? {1'b0, update_req_gpa_i[14:12]} : 4'b0;
//    
//        always@(*) begin
...
//        assign tc_update_req_i.addr         = update_req_gpa_i;
...
//        assign update_ack_idx_o             = tc_update_ack_o.idx[TLB_QIDX_WIDTH-1:0];
    ...
    /*parameter */              .CACHE_TYPE                 (1'b0                       ), // = 0, // 0:S2TC, 1:S1PTC
    ...
    /*input  logic [19:0]                               */  .update_req_pscid_i         (20'd0                      ),
    /*input  logic                                      */  .update_req_gv_i            (1'b0                       ),
    /*input  logic [15:0]                               */  .update_req_gscid_i         (update_req_gscid_i         ),
    /*input  logic [63:12]                              */  .update_req_va_i            (update_req_gpa_i           ),
    /*input  logic                                      */  .update_req_sxl_i           (1'b0                       ),
