...
//{{{ PARAM
    ...
    parameter type          MTLB_DAT_TYPE_L                                     = iommu_atd_cache_pkg::s2ptc_mtlb_dat_t_l,
    ...
    parameter   TECC_WIDTH                                          = 7,
    parameter   LDECC_WIDTH                                         = 6,
...
//=== Declare === {{{
    ...
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                               mtlb_b11_tram_cs_o   ;
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                               mtlb_b11_tram_wr_o   ;
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]   mtlb_b11_tram_addr_o ;
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]          mtlb_b11_tram_wdata_o;
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]          mtlb_b11_tram_rdata_i;
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                               mtlb_b11_iram_cs_o   ;
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                               mtlb_b11_iram_wr_o   ;
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]   mtlb_b11_iram_addr_o ;
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]          mtlb_b11_iram_wdata_o;
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]          mtlb_b11_iram_rdata_i;
    logic [BANK_L3_NUM-1:0]                                                     mtlb_b11_uram_cs_o   ;
    logic [BANK_L3_NUM-1:0]                                                     mtlb_b11_uram_wr_o   ;
    logic [BANK_L3_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]                         mtlb_b11_uram_addr_o ;
    MTLB_UTAG_TYPE [BANK_L3_NUM-1:0]                                            mtlb_b11_uram_wdata_o;
    MTLB_UTAG_TYPE [BANK_L3_NUM-1:0]                                            mtlb_b11_uram_rdata_i;
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                               mtlb_b11_dram_cs_o   ;
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                               mtlb_b11_dram_wr_o   ;
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]   mtlb_b11_dram_addr_o ;
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]        mtlb_b11_dram_wdata_o;
    logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]        mtlb_b11_dram_rdata_i;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                               mtlb_b04_tram_cs_o   ;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                               mtlb_b04_tram_wr_o   ;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]   mtlb_b04_tram_addr_o ;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]          mtlb_b04_tram_wdata_o;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]          mtlb_b04_tram_rdata_i;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                               mtlb_b04_iram_cs_o   ;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                               mtlb_b04_iram_wr_o   ;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]   mtlb_b04_iram_addr_o ;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]          mtlb_b04_iram_wdata_o;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]          mtlb_b04_iram_rdata_i;
    logic [BANK_L4_NUM-1:0]                                                     mtlb_b04_uram_cs_o   ;
    logic [BANK_L4_NUM-1:0]                                                     mtlb_b04_uram_wr_o   ;
    logic [BANK_L4_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]                         mtlb_b04_uram_addr_o ;
    MTLB_UTAG_TYPE [BANK_L4_NUM-1:0]                                            mtlb_b04_uram_wdata_o;
    MTLB_UTAG_TYPE [BANK_L4_NUM-1:0]                                            mtlb_b04_uram_rdata_i;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                               mtlb_b04_dram_cs_o   ;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                               mtlb_b04_dram_wr_o   ;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]   mtlb_b04_dram_addr_o ;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]        mtlb_b04_dram_wdata_o;
    logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]        mtlb_b04_dram_rdata_i;

    logic                                                                       ram_initial_done;

    logic [3:0]                                                                 mtlb_lookup_ack_o_pte_position;
    logic                                                                       mtlb_lookup_ack_o_is_leaf;
...
//    assign mtlb_lookup_ack_o_is_leaf    = mtlb_lookup_ack_o.PERM[2] | mtlb_lookup_ack_o.PERM[0];
    assign mtlb_lookup_ack_o_is_leaf    = mtlb_lookup_ack_o.lvl=='d0;
    assign ftlb_mtlb_update_req_valid_i = mtlb_lookup_ack_valid_demux[1] & mtlb_lookup_ack_hit_o & mtlb_lookup_ack_o_is_leaf;
...
//=== lookup ack mux {{{
generate
    if(CACHE_TYPE=='d0) begin : s2ptc_lookup_ack_con
        assign mtlb_lookup_ack_o_pte_position = (mtlb_lookup_ack_o.lvl=='d4) ? {1'b0, mtlb_lookup_ack_o.addr[50:48]} :
                                                (mtlb_lookup_ack_o.lvl=='d3) ? {1'b0, mtlb_lookup_ack_o.addr[41:39]} :
                                                (mtlb_lookup_ack_o.lvl=='d2) ? {1'b0, mtlb_lookup_ack_o.addr[32:30]} :
                                                (mtlb_lookup_ack_o.lvl=='d1) ? (csr_fctl_gxl_i       ==1'b1 ? {1'b0, mtlb_lookup_ack_o.addr[24:22]} : {1'b0, mtlb_lookup_ack_o.addr[23:21]}) :
                                                (mtlb_lookup_ack_o.lvl=='d0) ? mtlb_lookup_ack_o.addr[15:12] : 4'b0;

        assign lookup_ack_valid_o           = mtlb_lookup_ack_valid_demux[0] ? 1'b1                                     : ftlb_lookup_ack_valid_o   ;
        assign lookup_ack_o.idx             = mtlb_lookup_ack_valid_demux[0] ? mtlb_lookup_ack_o.idx[TLB_QIDX_WIDTH-1-3:0]: ftlb_lookup_ack_o.idx     ;
        ...
        assign lookup_ack_o.pte_position    = mtlb_lookup_ack_valid_demux[0] ? mtlb_lookup_ack_o_pte_position           : ftlb_lookup_ack_o.pte_position;
        ...
        assign lookup_ack_o.D               = mtlb_lookup_ack_valid_demux[0] ? mtlb_lookup_ack_o.D                      : ftlb_lookup_ack_o.D       ;
        assign lookup_ack_o.A               = mtlb_lookup_ack_valid_demux[0] ? mtlb_lookup_ack_o.A                      : ftlb_lookup_ack_o.A       ;
        assign lookup_ack_o.PPN             = mtlb_lookup_ack_valid_demux[0] ? mtlb_lookup_ack_o.PPN                    : ftlb_lookup_ack_o.PPN     ;
        assign lookup_ack_o.PERM            = mtlb_lookup_ack_valid_demux[0] ? mtlb_lookup_ack_o.PERM                   : ftlb_lookup_ack_o.PERM    ;
    ...
    else begin : s1ptc_lookup_ack_con
        assign mtlb_lookup_ack_o_pte_position = (mtlb_lookup_ack_o.lvl=='d4) ? {1'b0, mtlb_lookup_ack_o.addr[50:48]} :
                                                (mtlb_lookup_ack_o.lvl=='d3) ? {1'b0, mtlb_lookup_ack_o.addr[41:39]} :
                                                (mtlb_lookup_ack_o.lvl=='d2) ? {1'b0, mtlb_lookup_ack_o.addr[32:30]} :
                                                (mtlb_lookup_ack_o.lvl=='d1) ? (mtlb_lookup_ack_o.sxl==1'b1 ? {1'b0, mtlb_lookup_ack_o.addr[24:22]} : {1'b0, mtlb_lookup_ack_o.addr[23:21]}) :
                                                (mtlb_lookup_ack_o.lvl=='d0) ? mtlb_lookup_ack_o.addr[15:12] : 4'b0;
...
//=== microTLB inst === {{{
    ...
    /*parameter type         */ .LOOKUP_REQ_TYPE            (LOOKUP_REQ_TYPE                ), // = iommu_acd_pkg::s2ptc_lookup_req_t,
    /*parameter type         */ .LOOKUP_ACK_TYPE            (LOOKUP_ACK_TYPE                ), // = iommu_acd_pkg::s2ptc_lookup_ack_t,
    /*parameter type         */ .UPDATE_REQ_TYPE            (UPDATE_REQ_TYPE                ), // = iommu_acd_pkg::s2ptc_update_req_t,
    /*parameter type         */ .MICROTLB_TAG_TYPE          (MICROTLB_TAG_TYPE              ), // = iommu_atd_cache_pkg::s2ptc_microtlb_tag_t,
    /*parameter type         */ .MICROTLB_INV_TAG_TYPE      (MICROTLB_INV_TAG_TYPE          ), // = iommu_atd_cache_pkg::s2ptc_microtlb_inv_tag_t,
    /*parameter type         */ .MICROTLB_CONTENT_TYPE      (MICROTLB_CONTENT_TYPE          ), // = iommu_atd_cache_pkg::s2ptc_microtlb_content_t,
...
//=== mainTLB inst === {{{
    ...
    /*parameter type         */ .MTLB_TAG_TYPE                                              (MTLB_TAG_TYPE                  ), // = iommu_atd_cache_pkg::s2ptc_mtlb_tag_t,
    /*parameter type         */ .MTLB_ITAG_TYPE                                             (MTLB_ITAG_TYPE                 ), // = iommu_atd_cache_pkg::s2ptc_mtlb_itag_t,
    /*parameter type         */ .MTLB_UTAG_TYPE                                             (MTLB_UTAG_TYPE                 ), // = iommu_atd_cache_pkg::s2ptc_mtlb_utag_t,
    /*parameter type         */ .MTLB_DAT_TYPE                                              (MTLB_DAT_TYPE_L                ), // = iommu_atd_cache_pkg::s2ptc_mtlb_dat_t_l,
    /*parameter type         */ .MTLB_DAT_TYPE_NL                                           (MTLB_DAT_TYPE_NL               ), // = iommu_atd_cache_pkg::s2ptc_mtlb_dat_t_nl,
    /*parameter  */ .BANK_L4_EMPTY                                              (BANK_L4_EMPTY                  ), // = 0,
    ...
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                              */  .b11_tram_cs_o                  (mtlb_b11_tram_cs_o                 ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                              */  .b11_tram_wr_o                  (mtlb_b11_tram_wr_o                 ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]  */  .b11_tram_addr_o                (mtlb_b11_tram_addr_o               ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]         */  .b11_tram_wdata_o               (mtlb_b11_tram_wdata_o              ),
    /*input  logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]         */  .b11_tram_rdata_i               (mtlb_b11_tram_rdata_i              ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                              */  .b11_iram_cs_o                  (mtlb_b11_iram_cs_o                 ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                              */  .b11_iram_wr_o                  (mtlb_b11_iram_wr_o                 ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]  */  .b11_iram_addr_o                (mtlb_b11_iram_addr_o               ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]         */  .b11_iram_wdata_o               (mtlb_b11_iram_wdata_o              ),
    /*input  logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]         */  .b11_iram_rdata_i               (mtlb_b11_iram_rdata_i              ),
    /*output logic [BANK_L3_NUM-1:0]                                                    */  .b11_uram_cs_o                  (mtlb_b11_uram_cs_o                 ),
    /*output logic [BANK_L3_NUM-1:0]                                                    */  .b11_uram_wr_o                  (mtlb_b11_uram_wr_o                 ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]                        */  .b11_uram_addr_o                (mtlb_b11_uram_addr_o               ),
    /*output MTLB_UTAG_TYPE [BANK_L3_NUM-1:0]                                           */  .b11_uram_wdata_o               (mtlb_b11_uram_wdata_o              ),
    /*input  MTLB_UTAG_TYPE [BANK_L3_NUM-1:0]                                           */  .b11_uram_rdata_i               (mtlb_b11_uram_rdata_i              ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                              */  .b11_dram_cs_o                  (mtlb_b11_dram_cs_o                 ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                              */  .b11_dram_wr_o                  (mtlb_b11_dram_wr_o                 ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]  */  .b11_dram_addr_o                (mtlb_b11_dram_addr_o               ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]       */  .b11_dram_wdata_o               (mtlb_b11_dram_wdata_o              ),
    /*input  logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]       */  .b11_dram_rdata_i               (mtlb_b11_dram_rdata_i              ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                              */  .b04_tram_cs_o                  (mtlb_b04_tram_cs_o                 ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                              */  .b04_tram_wr_o                  (mtlb_b04_tram_wr_o                 ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]  */  .b04_tram_addr_o                (mtlb_b04_tram_addr_o               ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]         */  .b04_tram_wdata_o               (mtlb_b04_tram_wdata_o              ),
    /*input  logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]         */  .b04_tram_rdata_i               (mtlb_b04_tram_rdata_i              ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                              */  .b04_iram_cs_o                  (mtlb_b04_iram_cs_o                 ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                              */  .b04_iram_wr_o                  (mtlb_b04_iram_wr_o                 ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]  */  .b04_iram_addr_o                (mtlb_b04_iram_addr_o               ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]         */  .b04_iram_wdata_o               (mtlb_b04_iram_wdata_o              ),
    /*input  logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]         */  .b04_iram_rdata_i               (mtlb_b04_iram_rdata_i              ),
    /*output logic [BANK_L4_NUM-1:0]                                                    */  .b04_uram_cs_o                  (mtlb_b04_uram_cs_o                 ),
    /*output logic [BANK_L4_NUM-1:0]                                                    */  .b04_uram_wr_o                  (mtlb_b04_uram_wr_o                 ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]                        */  .b04_uram_addr_o                (mtlb_b04_uram_addr_o               ),
    /*output MTLB_UTAG_TYPE [BANK_L4_NUM-1:0]                                           */  .b04_uram_wdata_o               (mtlb_b04_uram_wdata_o              ),
    /*input  MTLB_UTAG_TYPE [BANK_L4_NUM-1:0]                                           */  .b04_uram_rdata_i               (mtlb_b04_uram_rdata_i              ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                              */  .b04_dram_cs_o                  (mtlb_b04_dram_cs_o                 ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                              */  .b04_dram_wr_o                  (mtlb_b04_dram_wr_o                 ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]  */  .b04_dram_addr_o                (mtlb_b04_dram_addr_o               ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]       */  .b04_dram_wdata_o               (mtlb_b04_dram_wdata_o              ),
    /*input  logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]       */  .b04_dram_rdata_i               (mtlb_b04_dram_rdata_i              ),
    /*input  logic                                                                      */  .csr_fctl_gxl_i                 (csr_fctl_gxl_i                 ),
    /*input  logic                                                                      */  .multi_hit_check_i              (multi_hit_check_i              ),
...
//=== MTLB RAM inst {{{
    ...
    /*parameter  */ .BANK_L1_WAY_IDX_WIDTH                                      (BANK_L1_WAY_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_BANK_L1_WAY_IDX_WIDTH,
    /*parameter  */ .BANK_L2_WAY_IDX_WIDTH                                      (BANK_L2_WAY_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_BANK_L2_WAY_IDX_WIDTH,
    /*parameter  */ .BANK_L3_WAY_IDX_WIDTH                                      (BANK_L3_WAY_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_BANK_L2_WAY_IDX_WIDTH,
    /*parameter  */ .BANK_L4_WAY_IDX_WIDTH                                      (BANK_L4_WAY_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_BANK_L2_WAY_IDX_WIDTH,
    /*parameter type         */ .MTLB_TAG_TYPE                                              (MTLB_TAG_TYPE                  ), // = iommu_atd_cache_pkg::s2ptc_mtlb_tag_t,
    /*parameter type         */ .MTLB_ITAG_TYPE                                             (MTLB_ITAG_TYPE                 ), // = iommu_atd_cache_pkg::s2ptc_mtlb_itag_t,
    /*parameter type         */ .MTLB_UTAG_TYPE                                             (MTLB_UTAG_TYPE                 ), // = iommu_atd_cache_pkg::s2ptc_mtlb_utag_t,
    /*parameter type         */ .MTLB_DAT_TYPE                                              (MTLB_DAT_TYPE_L                ), // = iommu_atd_cache_pkg::s2ptc_mtlb_dat_t_l,
    ...
    /*input  logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                              */  .b11_tram_cs_i          (mtlb_b11_tram_cs_o     ),
    /*input  logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                              */  .b11_tram_wr_i          (mtlb_b11_tram_wr_o     ),
    /*input  logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]  */  .b11_tram_addr_i        (mtlb_b11_tram_addr_o   ),
    /*input  logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]         */  .b11_tram_wdata_i       (mtlb_b11_tram_wdata_o  ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]         */  .b11_tram_rdata_o       (mtlb_b11_tram_rdata_i  ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                              */  .b11_iram_cs_i          (mtlb_b11_iram_cs_o     ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                              */  .b11_iram_wr_i          (mtlb_b11_iram_wr_o     ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]  */  .b11_iram_addr_i        (mtlb_b11_iram_addr_o   ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]         */  .b11_iram_wdata_i       (mtlb_b11_iram_wdata_o  ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]         */  .b11_iram_rdata_o       (mtlb_b11_iram_rdata_i  ),
    /*input  logic [BANK_L3_NUM-1:0]                                                    */  .b11_uram_cs_i          (mtlb_b11_uram_cs_o     ),
    /*input  logic [BANK_L3_NUM-1:0]                                                    */  .b11_uram_wr_i          (mtlb_b11_uram_wr_o     ),
    /*input  logic [BANK_L3_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]                        */  .b11_uram_addr_i        (mtlb_b11_uram_addr_o   ),
    /*input  MTLB_UTAG_TYPE [BANK_L3_NUM-1:0]                                           */  .b11_uram_wdata_i       (mtlb_b11_uram_wdata_o  ),
    /*output MTLB_UTAG_TYPE [BANK_L3_NUM-1:0]                                           */  .b11_uram_rdata_o       (mtlb_b11_uram_rdata_i  ),
    /*input  logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                              */  .b11_dram_cs_i          (mtlb_b11_dram_cs_o     ),
    /*input  logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                              */  .b11_dram_wr_i          (mtlb_b11_dram_wr_o     ),
    /*input  logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]  */  .b11_dram_addr_i        (mtlb_b11_dram_addr_o   ),
    /*input  logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]       */  .b11_dram_wdata_i       (mtlb_b11_dram_wdata_o  ),
    /*output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]       */  .b11_dram_rdata_o       (mtlb_b11_dram_rdata_i  ),
    /*input  logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                              */  .b04_tram_cs_i          (mtlb_b04_tram_cs_o     ),
    /*input  logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                              */  .b04_tram_wr_i          (mtlb_b04_tram_wr_o     ),
    /*input  logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]  */  .b04_tram_addr_i        (mtlb_b04_tram_addr_o   ),
    /*input  logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]         */  .b04_tram_wdata_i       (mtlb_b04_tram_wdata_o  ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]         */  .b04_tram_rdata_o       (mtlb_b04_tram_rdata_i  ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                              */  .b04_iram_cs_i          (mtlb_b04_iram_cs_o     ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                              */  .b04_iram_wr_i          (mtlb_b04_iram_wr_o     ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]  */  .b04_iram_addr_i        (mtlb_b04_iram_addr_o   ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]         */  .b04_iram_wdata_i       (mtlb_b04_iram_wdata_o  ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]         */  .b04_iram_rdata_o       (mtlb_b04_iram_rdata_i  ),
    /*input  logic [BANK_L4_NUM-1:0]                                                    */  .b04_uram_cs_i          (mtlb_b04_uram_cs_o     ),
    /*input  logic [BANK_L4_NUM-1:0]                                                    */  .b04_uram_wr_i          (mtlb_b04_uram_wr_o     ),
    /*input  logic [BANK_L4_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]                        */  .b04_uram_addr_i        (mtlb_b04_uram_addr_o   ),
    /*input  MTLB_UTAG_TYPE [BANK_L4_NUM-1:0]                                           */  .b04_uram_wdata_i       (mtlb_b04_uram_wdata_o  ),
    /*output MTLB_UTAG_TYPE [BANK_L4_NUM-1:0]                                           */  .b04_uram_rdata_o       (mtlb_b04_uram_rdata_i  ),
    /*input  logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                              */  .b04_dram_cs_i          (mtlb_b04_dram_cs_o     ),
    /*input  logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                              */  .b04_dram_wr_i          (mtlb_b04_dram_wr_o     ),
    /*input  logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]  */  .b04_dram_addr_i        (mtlb_b04_dram_addr_o   ),
    /*input  logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]       */  .b04_dram_wdata_i       (mtlb_b04_dram_wdata_o  ),
    /*output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]       */  .b04_dram_rdata_o       (mtlb_b04_dram_rdata_i  ),
    /*input  logic                                                                      */  .spare_in                       (1'b0                   )
    );
