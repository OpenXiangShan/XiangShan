...
module iommu_atd_ptc_main_tlb #( //{{{
    ...
    parameter   TECC_WIDTH                                                  = 6,
    parameter   LDECC_WIDTH                                                 = 7,
...
//=== IO {{{
    ...
    output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                                b11_tram_cs_o,
    output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                                b11_tram_wr_o,
    output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]    b11_tram_addr_o,
    output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]           b11_tram_wdata_o,
    input  logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]           b11_tram_rdata_i,
    output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                                b11_iram_cs_o,
    output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                                b11_iram_wr_o,
    output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]    b11_iram_addr_o,
    output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]           b11_iram_wdata_o,
    input  logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]           b11_iram_rdata_i,
    output logic [BANK_L3_NUM-1:0]                                                      b11_uram_cs_o,
    output logic [BANK_L3_NUM-1:0]                                                      b11_uram_wr_o,
    output logic [BANK_L3_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]                          b11_uram_addr_o,
    output MTLB_UTAG_TYPE [BANK_L3_NUM-1:0]                                             b11_uram_wdata_o,
    input  MTLB_UTAG_TYPE [BANK_L3_NUM-1:0]                                             b11_uram_rdata_i,
    output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                                b11_dram_cs_o,
    output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0]                                b11_dram_wr_o,
    output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [BANK_L3_SET_IDX_WIDTH-1:0]    b11_dram_addr_o,
    output logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]         b11_dram_wdata_o,
    input  logic [BANK_L3_NUM-1:0] [BANK_L3_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]         b11_dram_rdata_i,

    output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                                b04_tram_cs_o,
    output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                                b04_tram_wr_o,
    output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]    b04_tram_addr_o,
    output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]           b04_tram_wdata_o,
    input  logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]           b04_tram_rdata_i,
    output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                                b04_iram_cs_o,
    output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                                b04_iram_wr_o,
    output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]    b04_iram_addr_o,
    output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]           b04_iram_wdata_o,
    input  logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]           b04_iram_rdata_i,
    output logic [BANK_L4_NUM-1:0]                                                      b04_uram_cs_o,
    output logic [BANK_L4_NUM-1:0]                                                      b04_uram_wr_o,
    output logic [BANK_L4_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]                          b04_uram_addr_o,
    output MTLB_UTAG_TYPE [BANK_L4_NUM-1:0]                                             b04_uram_wdata_o,
    input  MTLB_UTAG_TYPE [BANK_L4_NUM-1:0]                                             b04_uram_rdata_i,
    output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                                b04_dram_cs_o,
    output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0]                                b04_dram_wr_o,
    output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [BANK_L4_SET_IDX_WIDTH-1:0]    b04_dram_addr_o,
    output logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]         b04_dram_wdata_o,
    input  logic [BANK_L4_NUM-1:0] [BANK_L4_WAY_NUM-1:0] [NLDRAM_DAT_WIDTH-1:0]         b04_dram_rdata_i,

    // CFG                                                                              
    input  logic                                                                        csr_fctl_gxl_i,
    input  logic                                                                        multi_hit_check_i,
    output logic [4:0]                                                                  multi_hit_fault_o,
...
//=== Declare === {{{
    ...
    logic [4:0]             [CABIN_LKP_NUM-1:0]         lkp_lkp2bank_req_valid_o;
    logic [4:0]             [CABIN_LKP_NUM-1:0]         lkp_lkp2bank_req_ready_i;
    bank_lkp_req_t    [4:0] [CABIN_LKP_NUM-1:0]         lkp_lkp2bank_req_o      ;
    logic [4:0]             [CABIN_LKP_NUM-1:0]         lkp_bank2lkp_ack_valid_i;
    bank_lkp_ack_t    [4:0] [CABIN_LKP_NUM-1:0]         lkp_bank2lkp_ack_i      ;
    logic [4:0]                                         lkp_bank_valid_i        ;

    lkp2bank_req_grp_t [4:0]                            lkp2bank_req;
    bank2lkp_ack_grp_t [4:0]                            bank2lkp_ack;
    ...
    logic [4:0]             [CABIN_UPD_NUM-1:0]         upd_upd2bank_req_valid_o;
    logic [4:0]             [CABIN_UPD_NUM-1:0]         upd_upd2bank_req_ready_i;
    bank_upd_req_t    [4:0] [CABIN_UPD_NUM-1:0]         upd_upd2bank_req_o      ;
    logic [4:0]             [CABIN_UPD_NUM-1:0]         upd_bank2upd_ack_valid_i;
    bank_upd_ack_t    [4:0] [CABIN_UPD_NUM-1:0]         upd_bank2upd_ack_i      ;

    upd2bank_req_grp_t [4:0]                            upd2bank_req;
    bank2upd_ack_grp_t [4:0]                            bank2upd_ack;
    ...
    logic             [4:0] [CABIN_INV_NUM-1:0]         inv_inv2bank_req_valid_o;
    logic             [4:0] [CABIN_INV_NUM-1:0]         inv_inv2bank_req_ready_i;
    bank_inv_req_t    [4:0] [CABIN_INV_NUM-1:0]         inv_inv2bank_req_o      ;
    logic             [4:0] [CABIN_INV_NUM-1:0]         inv_bank2inv_ack_valid_i;
    bank_inv_ack_t    [4:0] [CABIN_INV_NUM-1:0]         inv_bank2inv_ack_i      ;
    logic                                               inv_invalid_req_valid_o ;
    logic                                               inv_invalid_req_ready_i ;
    INVALID_REQ_TYPE                                    inv_invalid_req_o       ;


    inv2bank_req_grp_t [4:0]                            inv2bank_req;
    bank2inv_ack_grp_t [4:0]                            bank2inv_ack;

    logic [1:0]                                         upd_cabin_in_arb_valid_mux;
    logic [1:0]                                         upd_cabin_in_arb_ready_mux;
    UPDATE_REQ_TYPE [1:0]                               upd_cabin_in_arb_data_mux;

    logic [5-1:0] [1:0]                                 b_ecc_err_o;
    logic [1:0] [5-1:0]                                 ecc_err_o_int;

//}}}

//=== Main Code === {{{
    assign lkp_bank_valid_i = {{BANK_L4_EMPTY=='d1 ? 1'b1 : 1'b0}, 4'b1111};

    always@(*) begin
        for(int unsigned ei=0; ei<5; ei++) begin
...
//    assign lkp_lookup_ack_ready_i   = 1'b1                  ;
    ...
    iommu_atd_ptc_mtlb_lkp_cabin_wrap #(
    /*parameter type         */ .CACHE_TYPE                 (CACHE_TYPE                 ), // = 0, // 0:S2PTC, 1:S1PTC
    ...
    /*parameter type         */ .BANK_LKP_REQ_TYPE          (bank_lkp_req_t             ), // = iommu_atd_cache_pkg::s2ptc_bank_lkp_req_t,
    /*parameter type         */ .BANK_LKP_ACK_TYPE          (bank_lkp_ack_t             ), // = iommu_atd_cache_pkg::s2ptc_bank_lkp_ack_t,
    /*parameter  */ .CABIN_IDX_WIDTH            (CABIN_LKP_IDX_WIDTH        ), // = iommu_atd_cache_pkg::S2PTC_CABIN_LKP_IDX_WIDTH,
    ...
    /*output logic [4:0]             [CABIN_NUM-1:0]    */  .lkp2bank_req_valid_o       (lkp_lkp2bank_req_valid_o   ),
    /*input  logic [4:0]             [CABIN_NUM-1:0]    */  .lkp2bank_req_ready_i       (lkp_lkp2bank_req_ready_i   ),
    /*output BANK_LKP_REQ_TYPE [4:0] [CABIN_NUM-1:0]    */  .lkp2bank_req_o             (lkp_lkp2bank_req_o         ),
    /*input  logic [4:0]             [CABIN_NUM-1:0]    */  .bank2lkp_ack_valid_i       (lkp_bank2lkp_ack_valid_i   ),
    /*input  BANK_LKP_ACK_TYPE [4:0] [CABIN_NUM-1:0]    */  .bank2lkp_ack_i             (lkp_bank2lkp_ack_i         ),
    /*input  logic [4:0]                                */  .bank_valid_i               (lkp_bank_valid_i           ),
...
generate
    for(lkp2bank_b=0; lkp2bank_b<=4; lkp2bank_b++) begin : lkp2bank_req_connect_b_gen
...
generate
    for(bank2lkp_b=0; bank2lkp_b<=4; bank2lkp_b++) begin : bank2lkp_req_connect_b_gen
...
//    assign upd_update_req_i         = update_req_i          ;
    ...
    iommu_atd_ptc_mtlb_upd_cabin_wrap #(
    /*parameter type         */ .CACHE_TYPE                 (CACHE_TYPE                 ), // = 0, // 0:S2PTC, 1:S1PTC
    /*parameter type         */ .UPDATE_REQ_TYPE            (UPDATE_REQ_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_update_req_t,
    /*parameter type         */ .BANK_UPD_REQ_TYPE          (bank_upd_req_t             ), // = iommu_atd_cache_pkg::s2ptc_bank_upd_req_t,
    /*parameter type         */ .BANK_UPD_ACK_TYPE          (bank_upd_ack_t             ), // = iommu_atd_cache_pkg::s2ptc_bank_upd_ack_t,
    /*parameter  */ .CABIN_IDX_WIDTH            (CABIN_UPD_IDX_WIDTH        ), // = iommu_atd_cache_pkg::S2PTC_CABIN_UPD_IDX_WIDTH,
    /*parameter  */ .BANK_L0_IDX_WIDTH          (BANK_L0_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_BANK_L0_IDX_WIDTH,
    /*parameter  */ .BANK_L1_IDX_WIDTH          (BANK_L1_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_BANK_L1_IDX_WIDTH,
    /*parameter  */ .BANK_L2_IDX_WIDTH          (BANK_L2_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_BANK_L2_IDX_WIDTH,
    /*parameter  */ .BANK_L3_IDX_WIDTH          (BANK_L3_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_BANK_L3_IDX_WIDTH,
    ...
    /*output logic [4:0]             [CABIN_NUM-1:0]    */  .upd2bank_req_valid_o       (upd_upd2bank_req_valid_o   ),
    /*input  logic [4:0]             [CABIN_NUM-1:0]    */  .upd2bank_req_ready_i       (upd_upd2bank_req_ready_i   ),
    /*output BANK_UPD_REQ_TYPE [4:0] [CABIN_NUM-1:0]    */  .upd2bank_req_o             (upd_upd2bank_req_o         ),
    /*input  logic [4:0]             [CABIN_NUM-1:0]    */  .bank2upd_ack_valid_i       (upd_bank2upd_ack_valid_i   ),
    /*input  BANK_UPD_ACK_TYPE [4:0] [CABIN_NUM-1:0]    */  .bank2upd_ack_i             (upd_bank2upd_ack_i         ),
    /*input  logic                                      */  .spare_in                   (1'b0                       ) 
    );

genvar upd2bank_b, upd2bank_l;
generate
    for(upd2bank_b=0; upd2bank_b<=4; upd2bank_b++) begin : upd2bank_req_connect_b_gen
...
generate
    for(bank2upd_b=0; bank2upd_b<=4; bank2upd_b++) begin : bank2upd_req_connect_b_gen
...
//=== INV_CABIN_WRAP inst {{{
    ...
    iommu_atd_ptc_mtlb_inv_cabin_wrap #(
    /*parameter type         */ .CACHE_TYPE                 (CACHE_TYPE                 ), // = 0, // 0:S2PTC, 1:S1PTC
    /*parameter type         */ .INVALID_REQ_TYPE           (INVALID_REQ_TYPE           ), // = iommu_atd_cache_pkg::INVALID_REQ_TYPE,
    /*parameter type         */ .BANK_INV_REQ_TYPE          (bank_inv_req_t             ), // = iommu_atd_cache_pkg::s2ptc_bank_inv_req_t,
    /*parameter type         */ .BANK_INV_ACK_TYPE          (bank_inv_ack_t             ), // = iommu_atd_cache_pkg::s2ptc_bank_inv_ack_t,
    /*parameter  */ .CABIN_IDX_WIDTH            (CABIN_INV_IDX_WIDTH        ), // = iommu_atd_cache_pkg::S2PTC_CABIN_INV_IDX_WIDTH,
    /*parameter  */ .BANK_L0_IDX_WIDTH          (BANK_L0_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_BANK_L0_IDX_WIDTH,
    /*parameter  */ .BANK_L1_IDX_WIDTH          (BANK_L1_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_BANK_L1_IDX_WIDTH,
    /*parameter  */ .BANK_L2_IDX_WIDTH          (BANK_L2_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_BANK_L2_IDX_WIDTH,
    /*parameter  */ .BANK_L3_IDX_WIDTH          (BANK_L3_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_BANK_L3_IDX_WIDTH,
...
generate
    for(inv2bank_b=0; inv2bank_b<=4; inv2bank_b++) begin : inv2bank_req_connect_b_gen
...
generate
    for(bank2inv_b=0; bank2inv_b<=4; bank2inv_b++) begin : bank2inv_req_connect_b_gen
...
//=== BANK inst {{{
    iommu_atd_ptc_mtlb_bank_top #(
    /*parameter type         */ .CACHE_TYPE                                         (CACHE_TYPE                 ), // = 0, // 0:S2PTC, 1:PTC
    /*parameter  */ .BANK_TYPE                                          (3'b000                     ), // = 3'b00,
    /*parameter type         */ .INVALID_REQ_TYPE                                   (INVALID_REQ_TYPE           ), // = iommu_atd_cache_pkg::INVALID_REQ_TYPE,
    /*parameter type         */ .LOOKUP_REQ_TYPE                                    (LOOKUP_REQ_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_lookup_req_t,
    /*parameter type         */ .LOOKUP_ACK_TYPE                                    (LOOKUP_ACK_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_lookup_ack_t,
    /*parameter type         */ .UPDATE_REQ_TYPE                                    (UPDATE_REQ_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_update_req_t,
    ...
    /*parameter  */ .BANK_IDX_WIDTH                                     (BANK_L0_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_IDX_WIDTH,
    /*parameter  */ .BANK_SET_IDX_WIDTH                                 (BANK_L0_SET_IDX_WIDTH      ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_SET_IDX_WIDTH,
    /*parameter  */ .BANK_WAY_IDX_WIDTH                                 (BANK_L0_WAY_IDX_WIDTH      ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_WAY_IDX_WIDTH,
    ...
    /*parameter type         */ .MTLB_DAT_TYPE                                      (MTLB_DAT_TYPE              ), // = iommu_atd_cache_pkg::s2ptc_mtlb_dat_t_l,
    /*parameter  */ .TECC_WIDTH                                         (TECC_WIDTH                 ), // = 6,
    /*parameter  */ .DECC_WIDTH                                         (LDECC_WIDTH                ), // = 7,
    /*parameter  */ .SPARE_PARAM                                        (1'b0                       )  // = 0
    ) U_mtlb_bank_l0(
    /*input  logic                                                              */  .clk                        (clk                        ),
    /*input  logic                                                              */  .rstn                       (rstn                       ),
    ...
    iommu_atd_ptc_mtlb_bank_top #(
    /*parameter type         */ .CACHE_TYPE                                         (CACHE_TYPE                 ), // = 0, // 0:S1PTC, 1:S2PTC
    /*parameter  */ .BANK_TYPE                                          (3'b001                     ), // = 3'b00,
    /*parameter type         */ .INVALID_REQ_TYPE                                   (INVALID_REQ_TYPE           ), // = iommu_atd_cache_pkg::INVALID_REQ_TYPE,
    /*parameter type         */ .LOOKUP_REQ_TYPE                                    (LOOKUP_REQ_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_lookup_req_t,
    /*parameter type         */ .LOOKUP_ACK_TYPE                                    (LOOKUP_ACK_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_lookup_ack_t,
    /*parameter type         */ .UPDATE_REQ_TYPE                                    (UPDATE_REQ_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_update_req_t,
    ...
    /*parameter  */ .CABIN_UPD_IDX_WIDTH                                (CABIN_UPD_IDX_WIDTH        ), // = iommu_atd_cache_pkg::S2PTC_CABIN_UPD_IDX_WIDTH,
    /*parameter  */ .CABIN_INV_IDX_WIDTH                                (CABIN_INV_IDX_WIDTH        ), // = iommu_atd_cache_pkg::S2PTC_CABIN_INV_IDX_WIDTH,
    /*parameter  */ .BANK_IDX_WIDTH                                     (BANK_L1_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_IDX_WIDTH,
    /*parameter  */ .BANK_SET_IDX_WIDTH                                 (BANK_L1_SET_IDX_WIDTH      ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_SET_IDX_WIDTH,
    /*parameter  */ .BANK_WAY_IDX_WIDTH                                 (BANK_L1_WAY_IDX_WIDTH      ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_WAY_IDX_WIDTH,
    /*parameter type         */ .MTLB_TAG_TYPE                                      (MTLB_TAG_TYPE              ), // = iommu_atd_cache_pkg::s2ptc_mtlb_tag_t,
    /*parameter type         */ .MTLB_ITAG_TYPE                                     (MTLB_ITAG_TYPE             ), // = iommu_atd_cache_pkg::s2ptc_mtlb_itag_t,
    /*parameter type         */ .MTLB_UTAG_TYPE                                     (MTLB_UTAG_TYPE             ), // = iommu_atd_cache_pkg::s2ptc_mtlb_utag_t,
    /*parameter type         */ .MTLB_DAT_TYPE                                      (MTLB_DAT_TYPE_NL           ), // = iommu_atd_cache_pkg::s2ptc_mtlb_dat_t_nl,
    /*parameter  */ .TECC_WIDTH                                         (TECC_WIDTH                 ), // = 6,
    /*parameter  */ .DECC_WIDTH                                         (NLDECC_WIDTH               ), // = 7,
    /*parameter  */ .SPARE_PARAM                                        (1'b0                       )  // = 0
    ) U_mtlb_bank_l1(
    /*input  logic                                                              */  .clk                        (clk                        ),
    /*input  logic                                                              */  .rstn                       (rstn                       ),
    ...
    iommu_atd_ptc_mtlb_bank_top #(
    /*parameter type         */ .CACHE_TYPE                                         (CACHE_TYPE                 ), // = 0, // 0:S2PTC, 1:S1PTC
    /*parameter  */ .BANK_TYPE                                          (3'b010                     ), // = 3'b00,
    /*parameter type         */ .INVALID_REQ_TYPE                                   (INVALID_REQ_TYPE           ), // = iommu_atd_cache_pkg::INVALID_REQ_TYPE,
    /*parameter type         */ .LOOKUP_REQ_TYPE                                    (LOOKUP_REQ_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_lookup_req_t,
    /*parameter type         */ .LOOKUP_ACK_TYPE                                    (LOOKUP_ACK_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_lookup_ack_t,
    /*parameter type         */ .UPDATE_REQ_TYPE                                    (UPDATE_REQ_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_update_req_t,
    ...
    /*parameter  */ .CABIN_UPD_IDX_WIDTH                                (CABIN_UPD_IDX_WIDTH        ), // = iommu_atd_cache_pkg::S2PTC_CABIN_UPD_IDX_WIDTH,
    /*parameter  */ .CABIN_INV_IDX_WIDTH                                (CABIN_INV_IDX_WIDTH        ), // = iommu_atd_cache_pkg::S2PTC_CABIN_INV_IDX_WIDTH,
    /*parameter  */ .BANK_IDX_WIDTH                                     (BANK_L2_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_IDX_WIDTH,
    /*parameter  */ .BANK_SET_IDX_WIDTH                                 (BANK_L2_SET_IDX_WIDTH      ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_SET_IDX_WIDTH,
    /*parameter  */ .BANK_WAY_IDX_WIDTH                                 (BANK_L2_WAY_IDX_WIDTH      ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_WAY_IDX_WIDTH,
    /*parameter type         */ .MTLB_TAG_TYPE                                      (MTLB_TAG_TYPE              ), // = iommu_atd_cache_pkg::s2ptc_mtlb_tag_t,
    /*parameter type         */ .MTLB_ITAG_TYPE                                     (MTLB_ITAG_TYPE             ), // = iommu_atd_cache_pkg::s2ptc_mtlb_itag_t,
    /*parameter type         */ .MTLB_UTAG_TYPE                                     (MTLB_UTAG_TYPE             ), // = iommu_atd_cache_pkg::s2ptc_mtlb_utag_t,
    /*parameter type         */ .MTLB_DAT_TYPE                                      (MTLB_DAT_TYPE_NL           ), // = iommu_atd_cache_pkg::s2ptc_mtlb_dat_t_nl,
    ...
    iommu_atd_ptc_mtlb_bank_top #(
    /*parameter type         */ .CACHE_TYPE                                         (CACHE_TYPE                 ), // = 0, // 0:S2PTC, 1:S1PTC
    /*parameter  */ .BANK_TYPE                                          (3'b011                     ), // = 3'b00,
    /*parameter type         */ .INVALID_REQ_TYPE                                   (INVALID_REQ_TYPE           ), // = iommu_atd_cache_pkg::INVALID_REQ_TYPE,
    /*parameter type         */ .LOOKUP_REQ_TYPE                                    (LOOKUP_REQ_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_lookup_req_t,
    /*parameter type         */ .LOOKUP_ACK_TYPE                                    (LOOKUP_ACK_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_lookup_ack_t,
    /*parameter type         */ .UPDATE_REQ_TYPE                                    (UPDATE_REQ_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_update_req_t,
    ...
    /*parameter  */ .CABIN_UPD_IDX_WIDTH                                (CABIN_UPD_IDX_WIDTH        ), // = iommu_atd_cache_pkg::S2PTC_CABIN_UPD_IDX_WIDTH,
    /*parameter  */ .CABIN_INV_IDX_WIDTH                                (CABIN_INV_IDX_WIDTH        ), // = iommu_atd_cache_pkg::S2PTC_CABIN_INV_IDX_WIDTH,
    /*parameter  */ .BANK_IDX_WIDTH                                     (BANK_L3_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_IDX_WIDTH,
    /*parameter  */ .BANK_SET_IDX_WIDTH                                 (BANK_L3_SET_IDX_WIDTH      ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_SET_IDX_WIDTH,
    /*parameter  */ .BANK_WAY_IDX_WIDTH                                 (BANK_L3_WAY_IDX_WIDTH      ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_WAY_IDX_WIDTH,
    /*parameter type         */ .MTLB_TAG_TYPE                                      (MTLB_TAG_TYPE              ), // = iommu_atd_cache_pkg::s2ptc_mtlb_tag_t,
    /*parameter type         */ .MTLB_ITAG_TYPE                                     (MTLB_ITAG_TYPE             ), // = iommu_atd_cache_pkg::s2ptc_mtlb_itag_t,
    /*parameter type         */ .MTLB_UTAG_TYPE                                     (MTLB_UTAG_TYPE             ), // = iommu_atd_cache_pkg::s2ptc_mtlb_utag_t,
    /*parameter type         */ .MTLB_DAT_TYPE                                      (MTLB_DAT_TYPE_NL           ), // = iommu_atd_cache_pkg::s2ptc_mtlb_dat_t_nl,
    ...
    /*output logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]       */  .tram_wdata_o               (b11_tram_wdata_o           ),
    /*input  logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]       */  .tram_rdata_i               (b11_tram_rdata_i           ),
...
generate
    if(BANK_L4_EMPTY=='d1) begin : empty_l4_bank_gen
        assign lkp2bank_req[4].ready= 'd1;
        assign upd2bank_req[4].ready= 'd1;
        assign inv2bank_req[4].ready= 'd1;
        assign bank2lkp_ack[4].valid= {$bits(bank2lkp_ack[4].valid){1'b1}};
        assign bank2lkp_ack[4].ack  = 'd0;
        assign bank2upd_ack[4].valid= {$bits(bank2upd_ack[4].valid){1'b1}};
        assign bank2upd_ack[4].ack  = 'd0;
        assign bank2inv_ack[4].valid= {$bits(bank2inv_ack[4].valid){1'b1}};
        assign bank2inv_ack[4].ack  = 'd0;
        assign b04_tram_cs_o        = {$bits(b04_tram_cs_o){1'b1}};
        assign b04_tram_wr_o        = 'd0;
        assign b04_tram_addr_o      = 'd0;
        assign b04_tram_wdata_o     = 'd0;
        assign b04_iram_cs_o        = {$bits(b04_iram_cs_o){1'b1}};
        assign b04_iram_wr_o        = 'd0;
        assign b04_iram_addr_o      = 'd0;
        assign b04_iram_wdata_o     = 'd0;
        assign b04_uram_cs_o        = {$bits(b04_uram_cs_o){1'b1}};
        assign b04_uram_wr_o        = 'd0;
        assign b04_uram_addr_o      = 'd0;
        assign b04_uram_wdata_o     = 'd0;
        assign b04_dram_cs_o        = {$bits(b04_dram_cs_o){1'b1}};
        assign b04_dram_wr_o        = 'd0;
        assign b04_dram_addr_o      = 'd0;
        assign b04_dram_wdata_o     = 'd0;
        assign multi_hit_fault_o[4] = 'd0;
        assign b_ecc_err_o[4]       = 'd0;
    end
    else begin : non_empty_l4_bank_gen
    iommu_atd_ptc_mtlb_bank_top #(
    /*parameter type         */ .CACHE_TYPE                                         (CACHE_TYPE                 ), // = 0, // 0:S2PTC, 1:S1PTC
    /*parameter  */ .BANK_TYPE                                          (3'b100                     ), // = 3'b00,
    /*parameter type         */ .INVALID_REQ_TYPE                                   (INVALID_REQ_TYPE           ), // = iommu_atd_cache_pkg::INVALID_REQ_TYPE,
    /*parameter type         */ .LOOKUP_REQ_TYPE                                    (LOOKUP_REQ_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_lookup_req_t,
    /*parameter type         */ .LOOKUP_ACK_TYPE                                    (LOOKUP_ACK_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_lookup_ack_t,
    /*parameter type         */ .UPDATE_REQ_TYPE                                    (UPDATE_REQ_TYPE            ), // = iommu_atd_cache_pkg::s2ptc_update_req_t,
    ...
    /*parameter  */ .CABIN_UPD_IDX_WIDTH                                (CABIN_UPD_IDX_WIDTH        ), // = iommu_atd_cache_pkg::S2PTC_CABIN_UPD_IDX_WIDTH,
    /*parameter  */ .CABIN_INV_IDX_WIDTH                                (CABIN_INV_IDX_WIDTH        ), // = iommu_atd_cache_pkg::S2PTC_CABIN_INV_IDX_WIDTH,
    /*parameter  */ .BANK_IDX_WIDTH                                     (BANK_L4_IDX_WIDTH          ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_IDX_WIDTH,
    /*parameter  */ .BANK_SET_IDX_WIDTH                                 (BANK_L4_SET_IDX_WIDTH      ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_SET_IDX_WIDTH,
    /*parameter  */ .BANK_WAY_IDX_WIDTH                                 (BANK_L4_WAY_IDX_WIDTH      ), // = iommu_atd_cache_pkg::S2PTC_MAX_BANK_WAY_IDX_WIDTH,
    /*parameter type         */ .MTLB_TAG_TYPE                                      (MTLB_TAG_TYPE              ), // = iommu_atd_cache_pkg::s2ptc_mtlb_tag_t,
    /*parameter type         */ .MTLB_ITAG_TYPE                                     (MTLB_ITAG_TYPE             ), // = iommu_atd_cache_pkg::s2ptc_mtlb_itag_t,
    /*parameter type         */ .MTLB_UTAG_TYPE                                     (MTLB_UTAG_TYPE             ), // = iommu_atd_cache_pkg::s2ptc_mtlb_utag_t,
    /*parameter type         */ .MTLB_DAT_TYPE                                      (MTLB_DAT_TYPE_NL           ), // = iommu_atd_cache_pkg::s2ptc_mtlb_dat_t_nl,
    ...
    /*input  logic                                                              */  .clk                        (clk                        ),
    /*input  logic                                                              */  .rstn                       (rstn                       ),
    /*input  logic [CABIN_LKP_NUM-1:0]                                          */  .lkp_req_valid_i            (lkp2bank_req[4].valid      ),
    /*output logic [CABIN_LKP_NUM-1:0]                                          */  .lkp_req_ready_o            (lkp2bank_req[4].ready      ),
    /*input  BANK_LKP_REQ_TYPE [CABIN_LKP_NUM-1:0]                              */  .lkp_req_i                  (lkp2bank_req[4].req        ),
    /*input  logic [CABIN_UPD_NUM-1:0]                                          */  .upd_req_valid_i            (upd2bank_req[4].valid      ),
    /*output logic [CABIN_UPD_NUM-1:0]                                          */  .upd_req_ready_o            (upd2bank_req[4].ready      ),
    /*input  BANK_UPD_REQ_TYPE [CABIN_UPD_NUM-1:0]                              */  .upd_req_i                  (upd2bank_req[4].req        ),
    /*input  logic [CABIN_INV_NUM-1:0]                                          */  .inv_req_valid_i            (inv2bank_req[4].valid      ),
    /*output logic [CABIN_INV_NUM-1:0]                                          */  .inv_req_ready_o            (inv2bank_req[4].ready      ),
    /*input  BANK_INV_REQ_TYPE [CABIN_INV_NUM-1:0]                              */  .inv_req_i                  (inv2bank_req[4].req        ),
    /*output logic [CABIN_LKP_NUM-1:0]                                          */  .lkp_ack_valid_o            (bank2lkp_ack[4].valid      ),
    /*output BANK_LKP_ACK_TYPE [CABIN_LKP_NUM-1:0]                              */  .lkp_ack_o                  (bank2lkp_ack[4].ack        ),
    /*output logic [CABIN_UPD_NUM-1:0]                                          */  .upd_ack_valid_o            (bank2upd_ack[4].valid      ),
    /*output BANK_UPD_ACK_TYPE [CABIN_UPD_NUM-1:0]                              */  .upd_ack_o                  (bank2upd_ack[4].ack        ),
    /*output logic [CABIN_INV_NUM-1:0]                                          */  .inv_ack_valid_o            (bank2inv_ack[4].valid      ),
    /*output BANK_INV_ACK_TYPE [CABIN_INV_NUM-1:0]                              */  .inv_ack_o                  (bank2inv_ack[4].ack        ),
    /*output logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0]                            */  .tram_cs_o                  (b04_tram_cs_o              ),
    /*output logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0]                            */  .tram_wr_o                  (b04_tram_wr_o              ),
    /*output logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0] [BANK_SET_IDX_WIDTH-1:0]   */  .tram_addr_o                (b04_tram_addr_o            ),
    /*output logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]       */  .tram_wdata_o               (b04_tram_wdata_o           ),
    /*input  logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0] [TRAM_DAT_WIDTH-1:0]       */  .tram_rdata_i               (b04_tram_rdata_i           ),
    /*output logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0]                            */  .iram_cs_o                  (b04_iram_cs_o              ),
    /*output logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0]                            */  .iram_wr_o                  (b04_iram_wr_o              ),
    /*output logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0] [BANK_SET_IDX_WIDTH-1:0]   */  .iram_addr_o                (b04_iram_addr_o            ),
    /*output logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]       */  .iram_wdata_o               (b04_iram_wdata_o           ),
    /*input  logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0] [IRAM_DAT_WIDTH-1:0]       */  .iram_rdata_i               (b04_iram_rdata_i           ),
    /*output logic [BANK_NUM-1:0]                                               */  .uram_cs_o                  (b04_uram_cs_o              ),
    /*output logic [BANK_NUM-1:0]                                               */  .uram_wr_o                  (b04_uram_wr_o              ),
    /*output logic [BANK_NUM-1:0] [BANK_SET_IDX_WIDTH-1:0]                      */  .uram_addr_o                (b04_uram_addr_o            ),
    /*output MTLB_UTAG_TYPE [BANK_NUM-1:0]                                      */  .uram_wdata_o               (b04_uram_wdata_o           ),
    /*input  MTLB_UTAG_TYPE [BANK_NUM-1:0]                                      */  .uram_rdata_i               (b04_uram_rdata_i           ),
    /*output logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0]                            */  .dram_cs_o                  (b04_dram_cs_o              ),
    /*output logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0]                            */  .dram_wr_o                  (b04_dram_wr_o              ),
    /*output logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0] [BANK_SET_IDX_WIDTH-1:0]   */  .dram_addr_o                (b04_dram_addr_o            ),
    /*output logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0] [DRAM_DAT_WIDTH-1:0]       */  .dram_wdata_o               (b04_dram_wdata_o           ),
    /*input  logic [BANK_NUM-1:0] [BANK_WAY_NUM-1:0] [DRAM_DAT_WIDTH-1:0]       */  .dram_rdata_i               (b04_dram_rdata_i           ),
    /*input  logic                                                              */  .csr_fctl_gxl_i             (csr_fctl_gxl_i             ),
    /*input  logic                                                              */  .multi_hit_check_i          (multi_hit_check_i          ),
    /*output logic                                                              */  .multi_hit_fault_o          (multi_hit_fault_o[4]       ),
    /*output logic [1:0]                                                        */  .ecc_err_o                  (b_ecc_err_o[4]             ),
    /*input  logic                                                              */  .spare_in                   (1'b0                       ) 
    );
    end
endgenerate
