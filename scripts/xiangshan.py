...
class XSArgs(object):
    ...
    def __init__(self, args):
        ...
        self.rtl_simulator = args.rtl_simulator
...
class XiangShan(object):
    ...
    def build_emu(self):
        ...
        if self.args.rtl_simulator == "verilator":
...
if __name__ == "__main__":
    ...
    parser.add_argument('--rtl-simulator', '--emulator', dest='rtl_simulator', choices=['verilator', 'gsim'], default='verilator', help='RTL simulator backend')
