...
targets = {
    ...
    'IntDqStall': fr'{XS_CORE_PREFIX}.backend.inner\.ctrlBlock\.dispatch: IntDqStall,\s+(\d+)',
    'FpDqStall': fr'{XS_CORE_PREFIX}.backend.inner\.ctrlBlock\.dispatch: FpDqStall,\s+(\d+)',
    'LsDqStall': fr'{XS_CORE_PREFIX}.backend.inner\.ctrlBlock\.dispatch: LsDqStall,\s+(\d+)',
