...
tmp=$(grep "core.ctrlBlock.rob: clock_cycle," $filename)
total_cycles=${tmp##* }
tmp=$(grep "core.ctrlBlock.decode: fetch_bubbles," $filename)
fetch_bubbles=${tmp##* }
tmp=$(grep "core.ctrlBlock.decode: decode_bubbles," $filename)
decode_bubbles=${tmp##* }
tmp=$(grep "core.ctrlBlock.decode: slots_issued," $filename)
slots_issued=${tmp##* }
tmp=$(grep "core.ctrlBlock.rename: recovery_bubbles," $filename)
recovery_bubbles=${tmp##* }
tmp=$(grep "core.ctrlBlock.rob: commitUop," $filename)
slots_retired=${tmp##* }
tmp=$(grep "core.frontend.ftq: mispredictRedirect," $filename)
br_mispred_retired=${tmp##* }
tmp=$(grep "core.frontend.icache.mainPipe: icache_bubble_s2_miss," $filename)
icache_miss_cycles=${tmp##* }
tmp=$(grep "core.frontend.icache.mainPipe: icache_bubble_s0_tlb_miss," $filename)
itlb_miss_cycles=${tmp##* }
tmp=$(grep "core.frontend.bpu: s2_redirect," $filename)
s2_redirect_cycles=${tmp##* }
tmp=$(grep "core.frontend.bpu: s3_redirect," $filename)
...
tmp=$(grep "core.ctrlBlock.dispatch: stall_cycle_rob," $filename)
stall_cycle_rob=${tmp##* }
tmp=$(grep "core.ctrlBlock.dispatch: stall_cycle_int_dq," $filename)
stall_cycle_int_dq=${tmp##* }
tmp=$(grep "core.ctrlBlock.dispatch: stall_cycle_fp_dq," $filename)
stall_cycle_fp_dq=${tmp##* }
tmp=$(grep "core.ctrlBlock.dispatch: stall_cycle_ls_dq," $filename)
stall_cycle_ls_dq=${tmp##* }
tmp=$(grep "core.ctrlBlock.rename: stall_cycle_fp," $filename)
stall_cycle_fp=${tmp##* }
tmp=$(grep "core.ctrlBlock.rename: stall_cycle_int," $filename)
stall_cycle_int=${tmp##* }
tmp=$(grep "core.memBlock.lsq.loadQueue: l1d_loads_bound," $filename)
...
tmp=$(grep "l2cache: l2_loads_bound," $filename)
...
tmp=$(grep "core.ctrlBlock.decode: ifu2id_allNO_cycle," $filename)
