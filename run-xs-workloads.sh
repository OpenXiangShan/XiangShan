...
echo "========== 开始执行 coremark =========="
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/coremark-riscv64-xs.bin"; then
...
echo "========== 开始执行 dhrystone =========="
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/dhrystone-riscv64-xs.bin"; then
...
echo "========== 开始执行 hello =========="
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/hello-riscv64-xs.bin"; then
...
echo "========== 开始执行 hpmdriver =========="
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/hpmdriver-riscv64-xs.bin"; then
...
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/litenes-riscv64-xs.bin"; then
...
echo "========== 开始执行 maprobe =========="
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/maprobe-riscv64-xs.bin"; then
...
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/mem_test_bw-riscv64-xs.bin"; then
...
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/build-mem_test_latency--riscv64-xs.bin"; then
...
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/microbench-riscv64-xs.bin"; then
...
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/rva-trigger-riscv64-xs.bin"; then
...
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/rvv-trigger-riscv64-xs.bin"; then
...
echo "========== 开始执行 slider =========="
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/slider-riscv64-xs.bin"; then
...
echo "========== 开始执行 stream =========="
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/stream-riscv64-xs.bin"; then
...
echo "========== 开始执行 typing =========="
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/typing-riscv64-xs.bin"; then
...
echo "========== 开始执行 zcb-test =========="
if cd "$NOOP_HOME" &&
  ./build/emu -i "$WORKLOAD_DIR/zcb-test-riscv64-xs.bin"; then
