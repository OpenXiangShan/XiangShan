...
package seq_pkg;
    ...
    `include "memblock_csr_config_state.sv"
    `include "memblock_csr_randomizer.sv"
    ...
    `include "memblock_csr_initial_config_sequence.sv"
    `include "memblock_dynamic_csr_change_sequence.sv"
    ...
    `include "memblock_csr_scalar_stress_main_sequence_base.sv"
    `include "memblock_csr_scalar_load_10k_main_sequence.sv"
    `include "memblock_csr_scalar_store_10k_main_sequence.sv"
    `include "memblock_csr_scalar_mixed_10k_main_sequence.sv"
    `include "memblock_csr_scalar_store_sta_std_10k_main_sequence.sv"
    ...
    `include "memblock_mmu_sv39_pbmt0_non_nc_csr_sequence.sv"
    ...
    `include "memblock_dispatch_real_mmu_sv39_pbmt0_non_nc_vseq.sv"
    `include "memblock_csr_random_config_vseq.sv"
    `include "memblock_csr_scalar_stress_vseq_base.sv"
    `include "memblock_csr_scalar_load_10k_vseq.sv"
    `include "memblock_csr_scalar_store_10k_vseq.sv"
    `include "memblock_csr_scalar_mixed_10k_vseq.sv"
    `include "memblock_csr_scalar_store_sta_std_10k_vseq.sv"
