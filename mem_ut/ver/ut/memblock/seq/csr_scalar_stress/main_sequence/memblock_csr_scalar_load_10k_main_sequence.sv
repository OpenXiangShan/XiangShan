`ifndef MEMBLOCK_CSR_SCALAR_LOAD_10K_MAIN_SEQUENCE__SV
`define MEMBLOCK_CSR_SCALAR_LOAD_10K_MAIN_SEQUENCE__SV

class memblock_csr_scalar_load_10k_main_sequence extends
    memblock_csr_scalar_stress_main_sequence_base;
    `uvm_object_utils(memblock_csr_scalar_load_10k_main_sequence)

    function new(string name = "memblock_csr_scalar_load_10k_main_sequence");
        super.new(name);
    endfunction:new
    ...
    virtual function string stress_profile_name();
        return "SCALAR_LOAD_10K";
    endfunction:stress_profile_name
endclass:memblock_csr_scalar_load_10k_main_sequence
