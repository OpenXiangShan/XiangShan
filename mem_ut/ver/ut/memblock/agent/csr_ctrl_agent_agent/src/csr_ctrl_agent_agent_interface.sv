...
interface csr_ctrl_agent_agent_interface  (input bit clk,input bit rst_n);
    ...
    clocking drv_cb @(posedge clk);
        ...
        output io_ooo_to_mem_csrCtrl_bp_ctrl_btb_enable;
        output io_ooo_to_mem_csrCtrl_bp_ctrl_ras_enable;
        output io_ooo_to_mem_csrCtrl_bp_ctrl_sc_enable;
        output io_ooo_to_mem_csrCtrl_bp_ctrl_tage_enable;
        output io_ooo_to_mem_csrCtrl_bp_ctrl_ubtb_enable;
        output io_ooo_to_mem_csrCtrl_frontend_trigger_debugMode;
        output io_ooo_to_mem_csrCtrl_hd_misalign_ld_enable;
        output io_ooo_to_mem_csrCtrl_hd_misalign_st_enable;
        output io_ooo_to_mem_csrCtrl_mem_trigger_debugMode;
        output io_ooo_to_mem_tlbCsr_priv_debug;
    endclocking:drv_cb
    ...
    clocking mon_cb @(posedge clk);
        ...
        input  io_ooo_to_mem_tlbCsr_priv_debug;
    endclocking:mon_cb
