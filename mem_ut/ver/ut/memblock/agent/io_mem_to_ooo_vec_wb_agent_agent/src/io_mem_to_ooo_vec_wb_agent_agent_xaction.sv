...
class io_mem_to_ooo_vec_wb_agent_agent_xaction  extends tcnt_data_base;
    ...
    rand bit [`MEMBLOCK_DUT_ROB_VALUE_W-1:0] io_mem_to_ooo_writebackVldu_0_bits_uop_robIdx_value;
    ...
    rand bit [`MEMBLOCK_DUT_ROB_VALUE_W-1:0] io_mem_to_ooo_writebackVldu_1_bits_uop_robIdx_value;
