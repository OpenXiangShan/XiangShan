...
task io_mem_to_ooo_iq_feedback_agent_agent_monitor::mon_data();
    ...
    while(1) begin
        ...
        io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_isVecPartReplay = this.vif.mon_mp.mon_cb.io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_isVecPartReplay;
        io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_vecReplayMask = this.vif.mon_mp.mon_cb.io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_vecReplayMask;
        io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_vecReplayMbIdx = this.vif.mon_mp.mon_cb.io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_vecReplayMbIdx;
        io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_isVecPartReplay = this.vif.mon_mp.mon_cb.io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_isVecPartReplay;
        io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_vecReplayMask = this.vif.mon_mp.mon_cb.io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_vecReplayMask;
        io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_vecReplayMbIdx = this.vif.mon_mp.mon_cb.io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_vecReplayMbIdx;
        ...
        if(this.cfg.xz_sw==tcnt_dec_base::ON && this.vif.rst_n==1'b1 && memblock_sync_pkg::reset_backend_done==1'b1) begin
            ...
            `TCNT_CHECK_SIG_XZ(io_mem_to_ooo_staIqFeedback_0_feedbackSlow_bits_sqIdx_value,io_mem_to_ooo_staIqFeedback_0_feedbackSlow_bits_sqIdx_value,`MEMBLOCK_DUT_SQ_VALUE_W);
            ...
            `TCNT_CHECK_SIG_XZ(io_mem_to_ooo_staIqFeedback_1_feedbackSlow_bits_sqIdx_value,io_mem_to_ooo_staIqFeedback_1_feedbackSlow_bits_sqIdx_value,`MEMBLOCK_DUT_SQ_VALUE_W);
            ...
            `TCNT_CHECK_SIG_XZ(io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_sqIdx_value,io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_sqIdx_value,`MEMBLOCK_DUT_SQ_VALUE_W);
            ...
            `TCNT_CHECK_SIG_XZ(io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_lqIdx_value,io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_lqIdx_value,`MEMBLOCK_DUT_LQ_VALUE_W);
            ...
            `TCNT_CHECK_SIG_XZ(io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_sqIdx_value,io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_sqIdx_value,`MEMBLOCK_DUT_SQ_VALUE_W);
            ...
            `TCNT_CHECK_SIG_XZ(io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_lqIdx_value,io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_lqIdx_value,`MEMBLOCK_DUT_LQ_VALUE_W);
