...
`define MEMBLOCK__IO_MEM_TO_OOO_IQ_FEEDBACK_AGENT_CONNECT(U_IF_NAME,AGENT_PATH,RTL_PATH) \
    ...
    initial begin \
        ...
        force U_IF_NAME.io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_isVecPartReplay = RTL_PATH.io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_isVecPartReplay; \
        force U_IF_NAME.io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_vecReplayMask = RTL_PATH.io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_vecReplayMask; \
        force U_IF_NAME.io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_vecReplayMbIdx = RTL_PATH.io_mem_to_ooo_vstuIqFeedback_0_feedbackSlow_bits_vecReplayMbIdx; \
        force U_IF_NAME.io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_isVecPartReplay = RTL_PATH.io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_isVecPartReplay; \
        force U_IF_NAME.io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_vecReplayMask = RTL_PATH.io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_vecReplayMask; \
        force U_IF_NAME.io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_vecReplayMbIdx = RTL_PATH.io_mem_to_ooo_vstuIqFeedback_1_feedbackSlow_bits_vecReplayMbIdx; \
    end \
    `else \
    initial begin \
        force U_IF_NAME.io_mem_to_ooo_staIqFeedback_0_feedbackSlow_valid = RTL_PATH.io_mem_to_ooo_staIqFeedback_0_feedbackSlow_valid; \
