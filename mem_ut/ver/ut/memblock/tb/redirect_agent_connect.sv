...
`define MEMBLOCK__REDIRECT_AGENT_CONNECT(U_IF_NAME,AGENT_PATH,RTL_PATH) \
    ...
    initial begin \
        ...
        force RTL_PATH.io_redirect_bits_isVlsException = U_IF_NAME.io_redirect_bits_isVlsException; \
    ...
    initial begin \
        ...
        force U_IF_NAME.io_redirect_bits_isVlsException = RTL_PATH.io_redirect_bits_isVlsException; \
