...
class UncacheBundle(Bundle):
    SIGNAL_BINDINGS = {
        ...
        "a_bits_user_mem_back_type_mm": "auto_inner_instrUncache_client_out_a_bits_user_memBackType_MM",
        "a_bits_user_mem_page_type_nc": "auto_inner_instrUncache_client_out_a_bits_user_memPageType_NC",
    ...
    a_bits_user_mem_back_type_mm = Signal()
    a_bits_user_mem_page_type_nc = Signal()
    d_valid = Signal()
