...
from .py.ifu.sampler import (
    ...
    sample_cfvec_coverage as _sample_ifu_cfvec_coverage_impl,
)
...
# These signals are present in the VCS-oriented offset, but are not emitted by
# the current Verilator offset.  Keep their bins unclosed instead of mapping
# them to unrelated signals.
TWO_FETCH_OPTIONAL_SIGNAL_KEYS = frozenset(
    {
        "way_data_conflict",
        "ifu_first_invalid",
...
_TWO_FETCH_SIGNALS = {
    "ftq_valid": (
        ...
        "Frontend_top.Frontend.inner_icache.__Vtogcov__io_fromFtq_toMainPipe_valid",
    ),
    "ftq_ready": (
        "Frontend_top.Frontend.inner_icache.wayLookup.io_fromFtq_ready",
        "Frontend_top.Frontend.inner_icache.__Vtogcov__io_fromFtq_toMainPipe_ready",
    ),
    "ftq_req1_valid": (
    ...
    "ftq_req0_end": (
        ...
        "Frontend_top.Frontend.inner_icache.__Vtogcov__io_fromFtq_toMainPipe_bits_req_0_takenCfiOffset_bits",
    ),
    "ftq_req1_end": (
        "Frontend_top.Frontend.inner_icache.__Vtogcov__io_fromFtq_toWayLookup_bits_req_1_takenCfiOffset_bits",
        "Frontend_top.Frontend.inner_icache.__Vtogcov__io_fromFtq_toMainPipe_bits_req_1_takenCfiOffset_bits",
    ),
    "ftq_req0_exception": (
        "Frontend_top.Frontend.inner_icache.__Vtogcov__io_fromFtq_toWayLookup_bits_req_0_hasBackendException",
        "Frontend_top.Frontend.inner_icache.__Vtogcov__io_fromFtq_toMainPipe_bits_req_0_hasBackendException",
    ),
    "bpu_ptr_flag": (
...
def sample_cfvec_coverage(recorder, env, cycle: int) -> None:
    return _sample_ifu_cfvec_coverage_impl(recorder, env, cycle)
