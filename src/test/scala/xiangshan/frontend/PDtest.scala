...
class PDtest extends FlatSpec with ChiselScalatestTester with Matchers{
  ...
  it should "test PDecode" in {
    test(new PreDecode) { c =>
      println(s"\n--------------------cycle 1------------------\n")
      c.io.iCacheResp.fetchPc.poke(0.U)
      c.io.iCacheResp.mask.poke("b1111_1111_1111_0000".U)
      c.io.iCacheResp.data.poke(cacheLine1)
      c.clock.step()
      println(s"\n--------------------cycle 2------------------\n")
      c.io.iCacheResp.fetchPc.poke((1<<5).U)
      c.io.iCacheResp.mask.poke("b1111_1111_1111_1111".U)
      c.io.iCacheResp.data.poke(cacheLine2)
      c.clock.step()
      println(s"\n--------------------cycle 3------------------\n")
      c.io.iCacheResp.fetchPc.poke((2<<5).U)
      c.io.iCacheResp.mask.poke("b1111_1111_1111_1111".U)
      c.io.iCacheResp.data.poke(cacheLine1)
      c.clock.step()
      println(s"\n--------------------cycle 4------------------\n")
      c.io.iCacheResp.fetchPc.poke((3<<5).U)
      c.io.iCacheResp.mask.poke("b1111_1111_1111_1111".U)
      c.io.iCacheResp.data.poke(cacheLine2)
      c.clock.step()
    }
