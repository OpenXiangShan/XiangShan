...
//  s0_ghist := getHist(s0_ghist_ptr_dup(0))
  ...
  ghr.io.resp            := resp
  ghr.io.s1_valid_dup    := s1_valid_dup
  ghr.io.s0_fire_dup     := s0_fire_dup
  ghr.io.s1_fire_dup     := s1_fire_dup
  ghr.io.s2_fire_dup     := s2_fire_dup
  ghr.io.s0_stall_dup    := s0_stall_dup
  ghr.io.s2_redirect_dup := s2_redirect_dup
  ghr.io.s3_redirect_dup := s3_redirect_dup
  ghr.io.ftq_to_bpu      := io.ftq_to_bpu

  val s0_ghist         = ghr.io.s0_ghist
  val s0_folded_gh_dup = ghr.io.s0_folded_gh_dup
  val s1_folded_gh_dup = ghr.io.s1_folded_gh_dup
  val s3_ghist_ptr_dup = ghr.io.s3_ghist_ptr_dup
