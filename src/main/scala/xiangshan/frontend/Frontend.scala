...
// pmp
  ...
  io.ptw <> TLB(
    ...
    in = Seq(itlb_requestors(0), itlb_requestors(1), itlb_requestors(2), itlb_requestors(3)),
    sfence = io.sfence,
    csr = tlbCsr,
    width = 4,
    shouldBlock = true,
