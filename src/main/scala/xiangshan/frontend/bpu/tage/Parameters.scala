...
case class TageParameters(
    TableInfos: Seq[TageTableInfo] = Seq(
      ...
      new TageTableInfo(4096, 4, 4),
      new TageTableInfo(4096, 4, 9),
      new TageTableInfo(4096, 4, 17),
      new TageTableInfo(4096, 4, 29),
      new TageTableInfo(4096, 4, 56),
      new TageTableInfo(4096, 4, 109),
      new TageTableInfo(4096, 4, 211),
      new TageTableInfo(4096, 4, 397)
    ),
