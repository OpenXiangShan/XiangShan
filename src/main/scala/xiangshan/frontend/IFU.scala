  ...
  with HasPerfEvents
{
  ...
  val isWriteFetchToIBufferTable = WireInit(Constantin.createRecord(env.FPGAPlatform, "isWriteFetchToIBufferTable" + p(XSCoreParamsKey).HartId.toString))
  val isWriteIfuWbToFtqTable = WireInit(Constantin.createRecord(env.FPGAPlatform, "isWriteIfuWbToFtqTable" + p(XSCoreParamsKey).HartId.toString))
