...
//    def ret  = "b11_100".U
  ...
  object ALUOpType {
    ...
    def isAdd(func: UInt): Bool = func(6, 4) === "b010".U
    def isOddadd(func: UInt): Bool = (func(6, 4) === "b001".U || isAdd(func)) && func(3, 0) === "b0001".U
    def isAdduw(func: UInt): Bool = isAdd(func) && !func(3, 0).orR
    def isSradd(func: UInt): Bool = !func(3) && func(2)
    ...
    def isShadd(func: UInt): Bool = func(3)
    ...
    def isOthers(func: UInt): Bool = !func(6) && (func(5) && func(4) || !func(5) && func(3) || !func(5) && func(2) ||
      !func(5) && !func(0) || !func(5) && !func(4) || !func(3) && !func(2) && func(1)) || func(6)
