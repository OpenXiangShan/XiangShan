...
//    }
  ...
  val table: SeqMap[BitPat, SeqMap[SewLmulPattern, Seq[Opcode]]] = {
    ...
    val opi01Table = SeqMap[BitPat, SeqMap[SewLmulPattern, Seq[Opcode]]](
      ...
      VMV_V_V    -> dup(vmerge_vv_e8, vmerge_vv_e16, vmerge_vv_e32, vmerge_vv_e64)(_.S1v),
      VMV_V_X    -> dup(vmerge_vx_e8, vmerge_vx_e16, vmerge_vx_e32, vmerge_vx_e64)(_.S2x),
      VMV_V_I    -> dup(vmerge_vx_e8, vmerge_vx_e16, vmerge_vx_e32, vmerge_vx_e64)(_.vsi),
