...
object RVVDecodeUtil {
  class DecodePatternUtil[T <: DecodePattern](dp: T) {
    ...
    def ##[T1 <: DecodePattern, T2 <: DecodePattern](that: DecodePatternComb2[T1, T2]): DecodePatternComb3[T, T1, T2] = {
      new DecodePatternComb3[T, T1, T2](dp, that.p1, that.p2)
    }

    def ##[T1 <: DecodePattern, T2 <: DecodePattern, T3 <: DecodePattern](that: DecodePatternComb3[T1, T2, T3]): DecodePatternComb4[T, T1, T2, T3] = {
      new DecodePatternComb4[T, T1, T2, T3](dp, that.p1, that.p2, that.p3)
    }
  }

  implicit def DecodePatternToUtil[T <: DecodePattern](dp: T): DecodePatternUtil[T] = new DecodePatternUtil[T](dp)

  case class DecodePatternComb2[
    P1 <: DecodePattern,
    P2 <: DecodePattern,
  ](
    p1: P1,
  ...
  object LmulPattern {
    ...
    val m8 = LmulPattern(8)
    val m4 = LmulPattern(4)
    val m2 = LmulPattern(2)
    val m1 = LmulPattern(1)
    val mf2 = LmulPattern(0.5)
    val mf4 = LmulPattern(0.25)
    val mf8 = LmulPattern(0.125)
  }
  ...
  object SewPattern {
    ...
    val e8  = SewPattern(8)
    val e16 = SewPattern(16)
    val e32 = SewPattern(32)
