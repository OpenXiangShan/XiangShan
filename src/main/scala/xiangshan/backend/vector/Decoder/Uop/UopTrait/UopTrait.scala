...
case object Src1En  extends UopTrait
...
case object Src2En extends UopTrait
...
object NoSpec extends UopTrait

object BlockBack extends UopTrait

object FlushPipe extends UopTrait

object CannotRobCompress extends UopTrait

abstract class UopBase(baseTraits: UopTrait*) {

  var opcode: Opcode = null

  def setOpcode(opcode: Opcode): this.type = {
    this.opcode = opcode
    this
  }
...
case class NullVecUop() extends VecUop()
...
case object NeedVecEnable extends UopTrait
