...
//    FDivSqrtDecode.table ++
  ...
  block(Verification) {
    val instr =  WireInit(ctrl_flow.instr)
    dontTouch(instr)
    block(Verification.Cover) {
      cover(instr === BitPat("b????????????_?????_001_?????_0000111"))
      cover(instr === BitPat("b????????????_?????_001_?????_0100111"))
      cover(instr === BitPat("b?????10?????_?????_???_?????_1000011"))
      cover(instr === BitPat("b?????10?????_?????_???_?????_1000111"))
      cover(instr === BitPat("b?????10?????_?????_???_?????_1001011"))
      cover(instr === BitPat("b?????10?????_?????_???_?????_1001111"))
      cover(instr === BitPat("b0000010?????_?????_???_?????_1010011"))
      cover(instr === BitPat("b0000110?????_?????_???_?????_1010011"))
      cover(instr === BitPat("b0001010?????_?????_???_?????_1010011"))
      cover(instr === BitPat("b0001110?????_?????_???_?????_1010011"))
      cover(instr === BitPat("b010111000000_?????_???_?????_1010011"))
      cover(instr === BitPat("b0010010?????_?????_000_?????_1010011"))
      cover(instr === BitPat("b0010010?????_?????_001_?????_1010011"))
      cover(instr === BitPat("b0010010?????_?????_010_?????_1010011"))
      cover(instr === BitPat("b0010110?????_?????_000_?????_1010011"))
      cover(instr === BitPat("b0010110?????_?????_001_?????_1010011"))
      cover(instr === BitPat("b010000000010_?????_???_?????_1010011"))
      cover(instr === BitPat("b010001000000_?????_???_?????_1010011"))
      cover(instr === BitPat("b010000100010_?????_???_?????_1010011"))
      cover(instr === BitPat("b010001000001_?????_???_?????_1010011"))
  //    cover(instr === BitPat("b010001100010_?????_???_?????_1010011"))
  //    cover(instr === BitPat("b010001000011_?????_???_?????_1010011"))
      cover(instr === BitPat("b1010010?????_?????_010_?????_1010011"))
      cover(instr === BitPat("b1010010?????_?????_001_?????_1010011"))
      cover(instr === BitPat("b1010010?????_?????_000_?????_1010011"))
      cover(instr === BitPat("b111001000000_?????_001_?????_1010011"))
      cover(instr === BitPat("b110001000000_?????_???_?????_1010011"))
      cover(instr === BitPat("b110001000001_?????_???_?????_1010011"))
      cover(instr === BitPat("b111001000000_?????_000_?????_1010011"))
      cover(instr === BitPat("b110101000000_?????_???_?????_1010011"))
      cover(instr === BitPat("b110101000001_?????_???_?????_1010011"))
      cover(instr === BitPat("b111101000000_?????_000_?????_1010011"))
      cover(instr === BitPat("b110001000010_?????_???_?????_1010011"))
      cover(instr === BitPat("b110001000011_?????_???_?????_1010011"))
      cover(instr === BitPat("b110101000010_?????_???_?????_1010011"))
      cover(instr === BitPat("b110101000011_?????_???_?????_1010011"))
    }
  }
