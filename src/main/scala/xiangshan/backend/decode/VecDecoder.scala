...
case class OPIVV(src3: BitPat, fu: BitPat, fuOp: BitPat, vWen: Boolean, mWen: Boolean, vxsatWen: Boolean, uopDivType: BitPat = UopDivType.VEC_VVV) extends XSDecodeBase {
  def generate() : List[BitPat] = {
...
case class OPIVX(src3: BitPat, fu: BitPat, fuOp: BitPat, vWen: Boolean, mWen: Boolean, vxsatWen: Boolean, uopDivType: BitPat = UopDivType.VEC_VXV) extends XSDecodeBase {
  def generate() : List[BitPat] = {
...
case class OPIVI(src3: BitPat, fu: BitPat, fuOp: BitPat, vWen: Boolean, mWen: Boolean, vxsatWen: Boolean, selImm: BitPat, uopDivType: BitPat = UopDivType.VEC_VVV) extends XSDecodeBase {
  def generate() : List[BitPat] = {
...
object VecDecoder extends DecodeConstants {
  val opivv: Array[(BitPat, XSDecodeBase)] = Array(
    VADD_VV         -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vadd_vv, T, F, F),
    VSUB_VV         -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vsub_vv, T, F, F),

    VMINU_VV        -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vminu_vv, T, F, F),
    VMIN_VV         -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vmin_vv, T, F, F),
    VMAXU_VV        -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vmaxu_vv, T, F, F),
    VMAX_VV         -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vmax_vv, T, F, F),

    VAND_VV         -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vand_vv, T, F, F),
    VOR_VV          -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vor_vv, T, F, F),
    VXOR_VV         -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vxor_vv, T, F, F),
    ...
    VADC_VVM        -> OPIVV(SrcType.vp, FuType.vialuF, VialuFixType.vadc_vvm, T, F, F),
    VMADC_VVM       -> OPIVV(SrcType.vp, FuType.vialuF, VialuFixType.vmadc_vvm, F, T, F, UopDivType.VEC_VVM),
    VMADC_VV        -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vmadc_vv, F, T, F, UopDivType.VEC_VVM),

    VSBC_VVM        -> OPIVV(SrcType.vp, FuType.vialuF, VialuFixType.vsbc_vvm, T, F, F),
    VMSBC_VV        -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vmsbc_vv, F, T, F, UopDivType.VEC_VVM),
    VMSBC_VVM       -> OPIVV(SrcType.vp, FuType.vialuF, VialuFixType.vmsbc_vvm, F, T, F, UopDivType.VEC_VVM),

    VMERGE_VVM      -> OPIVV(SrcType.vp, FuType.vialuF, VialuFixType.vmerge_vvm, T, F, F),

    VMV_V_V      -> OPIVV(SrcType.vp, FuType.vialuF, VialuFixType.vmv_v_v, T, F, F),

    VMSEQ_VV        -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vmseq_vv, F, T, F, UopDivType.VEC_VVM),
    VMSNE_VV        -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vmsne_vv, F, T, F, UopDivType.VEC_VVM),
    VMSLTU_VV       -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vmsltu_vv, F, T, F, UopDivType.VEC_VVM),
    VMSLT_VV        -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vmslt_vv, F, T, F, UopDivType.VEC_VVM),
    VMSLEU_VV       -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vmsleu_vv, F, T, F, UopDivType.VEC_VVM),
    VMSLE_VV        -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vmsle_vv, F, T, F, UopDivType.VEC_VVM),

    VSLL_VV         -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vsll_vv, T, F, F),
    VSRL_VV         -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vsrl_vv, T, F, F),
    VSRA_VV         -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vsra_vv, T, F, F),
    VNSRL_WV        -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vnsrl_wv, T, F, F, UopDivType.VEC_WVV),
    VNSRA_WV        -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vnsra_wv, T, F, F, UopDivType.VEC_WVV),

    VSADDU_VV       -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vsaddu_vv, T, F, T),
    VSADD_VV        -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vsadd_vv, T, F, T),
    VSSUBU_VV       -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vssubu_vv, T, F, T),
    VSSUB_VV        -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vssub_vv, T, F, T),

    VSMUL_VV        -> OPIVV(SrcType.X, FuType.vipu, VipuType.dummy, T, F, T),

    VSSRL_VV        -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vssrl_vv, T, F, F),
    VSSRA_VV        -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vssra_vv, T, F, F),

    VNCLIPU_WV      -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vnclipu_wv, T, F, T, UopDivType.VEC_WVV),
    VNCLIP_WV       -> OPIVV(SrcType.X, FuType.vialuF, VialuFixType.vnclip_wv, T, F, T, UopDivType.VEC_WVV),
  ...
  val opivx: Array[(BitPat, XSDecodeBase)] = Array(
    VADD_VX       -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vadd_vv, T, F, F),
    VSUB_VX       -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vsub_vv, T, F, F),
    VRSUB_VX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vrsub_vv, T, F, F),

    VMINU_VX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vminu_vv, T, F, F),
    VMIN_VX       -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vmin_vv, T, F, F),
    VMAXU_VX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vmaxu_vv, T, F, F),
    VMAX_VX       -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vmax_vv, T, F, F),

    VAND_VX       -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vand_vv, T, F, F),
    VOR_VX        -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vor_vv, T, F, F),
    VXOR_VX       -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vxor_vv, T, F, F),
    ...
    VADC_VXM      -> OPIVX(SrcType.vp, FuType.vialuF, VialuFixType.vadc_vvm, T, F, F),
    VMADC_VXM      -> OPIVX(SrcType.vp, FuType.vialuF, VialuFixType.vmadc_vvm, F, T, F, UopDivType.VEC_VXM),
    VMADC_VX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vmadc_vv, F, T, F, UopDivType.VEC_VXM),
    VSBC_VXM      -> OPIVX(SrcType.vp, FuType.vialuF, VialuFixType.vsbc_vvm, T, F, F),
    VMSBC_VX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vmsbc_vv, F, T, F, UopDivType.VEC_VXM),
    VMSBC_VXM     -> OPIVX(SrcType.vp, FuType.vialuF, VialuFixType.vmsbc_vvm, F, T, F, UopDivType.VEC_VXM),

    VMERGE_VXM    -> OPIVX(SrcType.vp, FuType.vialuF, VialuFixType.vmerge_vvm, T, F, F),
    
    VMV_V_X    -> OPIVX(SrcType.vp, FuType.vialuF, VialuFixType.vmv_v_v, T, F, F),

    VMSEQ_VX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vmseq_vv, F, T, F, UopDivType.VEC_VXM),
    VMSNE_VX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vmsne_vv, F, T, F, UopDivType.VEC_VXM),
    VMSLTU_VX     -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vmsltu_vv, F, T, F, UopDivType.VEC_VXM),
    VMSLT_VX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vmslt_vv, F, T, F, UopDivType.VEC_VXM),
    VMSLEU_VX     -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vmsleu_vv, F, T, F, UopDivType.VEC_VXM),
    VMSLE_VX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vmsle_vv, F, T, F, UopDivType.VEC_VXM),
    VMSGTU_VX     -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vmsgtu_vv, F, T, F, UopDivType.VEC_VXM),
    VMSGT_VX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vmsgt_vv, F, T, F, UopDivType.VEC_VXM),

    VSLL_VX       -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vsll_vv, T, F, F),
    VSRL_VX       -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vsrl_vv, T, F, F),
    VSRA_VX       -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vsra_vv, T, F, F),
    VNSRL_WX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vnsrl_wv, T, F, F, UopDivType.VEC_WXV),
    VNSRA_WX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vnsra_wv, T, F, F, UopDivType.VEC_WXV),

    VSADDU_VX     -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vsaddu_vv, T, F, T),
    VSADD_VX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vsadd_vv, T, F, T),
    VSSUBU_VX     -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vssubu_vv, T, F, T),
    VSSUB_VX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vssub_vv, T, F, T),


    VSMUL_VX      -> OPIVX(SrcType.X, FuType.vipu, VipuType.dummy, T, F, T),

    VSSRL_VX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vssrl_vv, T, F, F),
    VSSRA_VX      -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vssra_vv, T, F, F),

    VNCLIPU_WX    -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vnclipu_wv, T, F, T, UopDivType.VEC_WXV),
    VNCLIP_WX     -> OPIVX(SrcType.X, FuType.vialuF, VialuFixType.vnclip_wv, T, F, T, UopDivType.VEC_WXV),
  )

  val opivi: Array[(BitPat, XSDecodeBase)] = Array(
    VADD_VI       -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vadd_vv,   T, F, F, SelImm.IMM_OPIVIS),
    VRSUB_VI      -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vrsub_vv, T, F, F, SelImm.IMM_OPIVIS),

    VAND_VI       -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vand_vv, T, F, F, SelImm.IMM_OPIVIS),
    VOR_VI        -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vor_vv, T, F, F, SelImm.IMM_OPIVIS),
    VXOR_VI       -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vxor_vv, T, F, F, SelImm.IMM_OPIVIS),
    ...
    VADC_VIM      -> OPIVI(SrcType.vp, FuType.vialuF, VialuFixType.vadc_vvm, T, F, F, SelImm.IMM_OPIVIS),
    VMADC_VIM     -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vmadc_vvm, T, F, F, SelImm.IMM_OPIVIS, UopDivType.VEC_VVM),
    VMADC_VI      -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vmadc_vv, T, F, F, SelImm.IMM_OPIVIS, UopDivType.VEC_VVM),

    VMERGE_VIM    -> OPIVI(SrcType.vp, FuType.vialuF, VialuFixType.vmerge_vvm, T, F, F, SelImm.IMM_OPIVIS),
    
    VMV_V_I    -> OPIVI(SrcType.vp, FuType.vialuF, VialuFixType.vmv_v_v, T, F, F, SelImm.IMM_OPIVIS),

    VMSEQ_VI      -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vmseq_vv, F, T, F, SelImm.IMM_OPIVIS, UopDivType.VEC_VVM),
    VMSNE_VI      -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vmsne_vv, F, T, F, SelImm.IMM_OPIVIS, UopDivType.VEC_VVM),
    VMSLEU_VI     -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vmsleu_vv, F, T, F, SelImm.IMM_OPIVIS, UopDivType.VEC_VVM),
    VMSLE_VI      -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vmsle_vv, F, T, F, SelImm.IMM_OPIVIS, UopDivType.VEC_VVM),
    VMSGTU_VI     -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vmsgtu_vv, F, T, F, SelImm.IMM_OPIVIS, UopDivType.VEC_VVM),
    VMSGT_VI      -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vmsgt_vv, F, T, F, SelImm.IMM_OPIVIS, UopDivType.VEC_VVM),

    VSLL_VI       -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vsll_vv, T, F, F, SelImm.IMM_OPIVIU),
    VSRL_VI       -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vsrl_vv, T, F, F, SelImm.IMM_OPIVIU),
    VSRA_VI       -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vsra_vv, T, F, F, SelImm.IMM_OPIVIU),
    VNSRL_WI      -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vnsrl_wv, T, F, F, SelImm.IMM_OPIVIU, UopDivType.VEC_WVV),
    VNSRA_WI      -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vnsra_wv, T, F, F, SelImm.IMM_OPIVIU, UopDivType.VEC_WVV),

    VSADDU_VI     -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vsaddu_vv, T, F, T, SelImm.IMM_OPIVIS),
    VSADD_VI      -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vsadd_vv, T, F, T, SelImm.IMM_OPIVIS),

    VSSRL_VI      -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vssrl_vv, T, F, F, SelImm.IMM_OPIVIU),
    VSSRA_VI      -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vssra_vv, T, F, F, SelImm.IMM_OPIVIU),

    VNCLIPU_WI    -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vnclipu_wv, T, F, T, SelImm.IMM_OPIVIU, UopDivType.VEC_WVV),
    VNCLIP_WI     -> OPIVI(SrcType.X, FuType.vialuF, VialuFixType.vnclip_wv, T, F, T, SelImm.IMM_OPIVIU, UopDivType.VEC_WVV),
  ...
  val opmvv: Array[(BitPat, XSDecodeBase)] = Array(
    VAADD_VV     -> OPMVV(F, FuType.vialuF, VialuFixType.vaadd_vv, F, T, F),
    VAADDU_VV    -> OPMVV(F, FuType.vialuF, VialuFixType.vaaddu_vv, F, T, F),
    VASUB_VV     -> OPMVV(F, FuType.vialuF, VialuFixType.vasub_vv, F, T, F),
    VASUBU_VV    -> OPMVV(F, FuType.vialuF, VialuFixType.vasubu_vv, F, T, F),
    ...
    VMAND_MM     -> OPMVV(F, FuType.vialuF, VialuFixType.vmand_mm, F, T, F, UopDivType.VEC_MMM),
    VMANDN_MM    -> OPMVV(F, FuType.vialuF, VialuFixType.vmandn_mm, F, T, F, UopDivType.VEC_MMM),
    VMNAND_MM    -> OPMVV(F, FuType.vialuF, VialuFixType.vmnand_mm, F, T, F, UopDivType.VEC_MMM),
    VMNOR_MM     -> OPMVV(F, FuType.vialuF, VialuFixType.vmnor_mm, F, T, F, UopDivType.VEC_MMM),
    VMOR_MM      -> OPMVV(F, FuType.vialuF, VialuFixType.vmor_mm, F, T, F, UopDivType.VEC_MMM),
    VMORN_MM     -> OPMVV(F, FuType.vialuF, VialuFixType.vmorn_mm, F, T, F, UopDivType.VEC_MMM),
    VMXNOR_MM    -> OPMVV(F, FuType.vialuF, VialuFixType.vmxnor_mm, F, T, F, UopDivType.VEC_MMM),
    VMXOR_MM     -> OPMVV(F, FuType.vialuF, VialuFixType.vmxor_mm, F, T, F, UopDivType.VEC_MMM),
    ...
    VSEXT_VF2    -> OPMVV(F, FuType.vialuF, VialuFixType.vsext_vf2, F, T, F, UopDivType.VEC_EXT2),
    VSEXT_VF4    -> OPMVV(F, FuType.vialuF, VialuFixType.vsext_vf4, F, T, F, UopDivType.VEC_EXT4),
    VSEXT_VF8    -> OPMVV(F, FuType.vialuF, VialuFixType.vsext_vf8, F, T, F, UopDivType.VEC_EXT8),
    VZEXT_VF2    -> OPMVV(F, FuType.vialuF, VialuFixType.vzext_vf2, F, T, F, UopDivType.VEC_EXT2),
    VZEXT_VF4    -> OPMVV(F, FuType.vialuF, VialuFixType.vzext_vf4, F, T, F, UopDivType.VEC_EXT4),
    VZEXT_VF8    -> OPMVV(F, FuType.vialuF, VialuFixType.vzext_vf8, F, T, F, UopDivType.VEC_EXT8),
    VWADD_VV     -> OPMVV(F, FuType.vialuF, VialuFixType.vwadd_vv, F, T, F, UopDivType.VEC_VVW),
    VWADD_WV     -> OPMVV(F, FuType.vialuF, VialuFixType.vwadd_wv, F, T, F, UopDivType.VEC_WVW),
    VWADDU_VV    -> OPMVV(F, FuType.vialuF, VialuFixType.vwaddu_vv, F, T, F, UopDivType.VEC_VVW),
    VWADDU_WV    -> OPMVV(F, FuType.vialuF, VialuFixType.vwaddu_wv, F, T, F, UopDivType.VEC_WVW),
    ...
    VWSUB_VV     -> OPMVV(F, FuType.vialuF, VialuFixType.vwsub_vv, F, T, F, UopDivType.VEC_VVW),
    VWSUB_WV     -> OPMVV(F, FuType.vialuF, VialuFixType.vwsub_wv, F, T, F, UopDivType.VEC_WVW),
    VWSUBU_VV    -> OPMVV(F, FuType.vialuF, VialuFixType.vwsubu_vv, F, T, F, UopDivType.VEC_VVW),
    VWSUBU_WV    -> OPMVV(F, FuType.vialuF, VialuFixType.vwsubu_wv, F, T, F, UopDivType.VEC_WVW),
  )

  val opmvx: Array[(BitPat, XSDecodeBase)] = Array(
    VAADD_VX       -> OPMVX(F, FuType.vialuF, VialuFixType.vaadd_vv, F, T, F),
    VAADDU_VX      -> OPMVX(F, FuType.vialuF, VialuFixType.vaaddu_vv, F, T, F),
    VASUB_VX       -> OPMVX(F, FuType.vialuF, VialuFixType.vasub_vv, F, T, F),
    VASUBU_VX      -> OPMVX(F, FuType.vialuF, VialuFixType.vasubu_vv, F, T, F),
    ...
    VMV_S_X        -> OPMVX(F, FuType.vipu, VipuType.vmv_s_x, F, T, F, UopDivType.VEC_0XV),
    ...
    VWADDU_WX      -> OPMVX(F, FuType.vialuF, VialuFixType.vwaddu_wv, F, T, F, UopDivType.VEC_WXW),
    ...
    VWSUB_VX       -> OPMVX(F, FuType.vialuF, VialuFixType.vwsub_vv, F, T, F, UopDivType.VEC_VXW),
    VWSUB_WX       -> OPMVX(F, FuType.vialuF, VialuFixType.vwsub_wv, F, T, F, UopDivType.VEC_WXW),
    VWSUBU_VX      -> OPMVX(F, FuType.vialuF, VialuFixType.vwsubu_vv, F, T, F, UopDivType.VEC_VXW),
    VWSUBU_WX      -> OPMVX(F, FuType.vialuF, VialuFixType.vwsubu_wv, F, T, F, UopDivType.VEC_WXW),
  )
