...
class CSR extends FunctionUnit with HasCSRConst
{
  ...
  var perfCntMapping = Map(
    ...
    MaskedRegMap(Mhpmcounter3, ibufFull),
    MaskedRegMap(Mhpmcounter4, roqFull),
    MaskedRegMap(Mhpmcounter5, intdqFull),
    MaskedRegMap(Mhpmcounter6, fpdqFull),
    MaskedRegMap(Mhpmcounter7, lsdqFull),
    MaskedRegMap(Mhpmcounter8, sqFull),
    MaskedRegMap(Mhpmcounter9, lqFull),
    MaskedRegMap(Mhpmcounter10, dcacheMSHRFull),
    MaskedRegMap(Mhpmcounter11, bpRight),
    MaskedRegMap(Mhpmcounter12, bpWrong),
    MaskedRegMap(Mhpmcounter13, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter14, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter15, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter16, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter17, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter18, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter19, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter20, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter21, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter22, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter23, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter24, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter25, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter26, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter27, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter28, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter29, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter30, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmcounter31, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mcountinhibit, mcountinhibit),
    MaskedRegMap(Mhpmevent3, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent4, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent5, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent6, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent7, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent8, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent9, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent10, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent11, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent12, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent13, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent14, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent15, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent16, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent17, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent18, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent19, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent20, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent21, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent22, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent23, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent24, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent25, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent26, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent27, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent28, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent29, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent30, RegInit(0.U(XLEN.W))),
    MaskedRegMap(Mhpmevent31, RegInit(0.U(XLEN.W))),
  )
  ...
  if (!env.FPGAPlatform) {
    ...
    difftest.valid := raiseIntr || csrio.exception.valid
