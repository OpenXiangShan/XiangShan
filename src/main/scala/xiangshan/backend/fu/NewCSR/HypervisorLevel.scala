...
trait HypervisorLevel { self: NewCSR =>
  ...
  val hstateen0 = Module(new CSRModule("Hstateen0", new HstateenBundle0) with HasStateenBundle {
  ...
  val hstateen1 = Module(new CSRModule("Hstateen1", new StateenNonZeroBundle) with HasStateenBundle {
    regOut := reg.asUInt & fromMstateen1.asUInt
  }).setAddr(CSRs.hstateen1)

  val hstateen2 = Module(new CSRModule("Hstateen2", new StateenNonZeroBundle) with HasStateenBundle {
    regOut := reg.asUInt & fromMstateen2.asUInt
  }).setAddr(CSRs.hstateen2)

  val hstateen3 = Module(new CSRModule("Hstateen3", new StateenNonZeroBundle) with HasStateenBundle {
