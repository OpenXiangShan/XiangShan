...
trait HasL1PrefetchSourceParameter {
  ...
  // Requests generated by MemoryDependencePrefetcher and sent through the
  // common PrefetcherWrapper L1 arbiter.
  def L1_HW_PREFETCH_MDP = 6.U
  ...
  def isFromMDP(value: UInt) = value === L1_HW_PREFETCH_MDP
