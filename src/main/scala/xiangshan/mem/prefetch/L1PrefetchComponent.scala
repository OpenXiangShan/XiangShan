...
class MutiLevelPrefetchFilter(implicit p: Parameters) extends XSModule with HasL1PrefetchHelper {
  ...
  XSPerfAccumulate("l1_hash_conflict", s0_l1_valid && RegNext(s1_l1_valid) && (s0_l1_region =/= RegEnable(s1_l1_region, s1_l1_valid)) && (s0_l1_region_hash === RegEnable(s1_l1_region_hash, s1_l1_valid)))
