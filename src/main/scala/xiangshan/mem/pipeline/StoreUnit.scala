...
import xiangshan.cache.mmu.{HasTlbConst, TlbCmd, TlbReq, TlbRequestIO, TlbResp, Pbmt}
...
class StoreUnit(implicit p: Parameters) extends XSModule
  ...
  val s0_facC0 = s0_stin.src(0)(sectorvpnOffLen - 1, 0)  +& SignExt(s0_stin.uop.imm(11, 0), sectorppnLen)
