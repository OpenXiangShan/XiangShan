  ...
  with SdtrigExt
{
  ...
  sqOtherStout.valid := lsq.io.mmioStout.valid || lsq.io.cboZerotout.valid
  sqOtherStout.bits  := Mux(lsq.io.cboZerotout.valid, lsq.io.cboZerotout.bits, lsq.io.mmioStout.bits)
  assert(!(lsq.io.mmioStout.valid && lsq.io.cboZerotout.valid), "Cannot writeback to mmio and cboZero at the same time.")
  ...
  lsq.io.mmioStout.ready := sqOtherStout.ready && !lsq.io.cboZerotout.valid
  lsq.io.cboZerotout.ready := sqOtherStout.ready
