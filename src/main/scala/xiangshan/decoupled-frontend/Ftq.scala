...
//     val stage3Redirect = Flipped(ValidIO(new Redirect))
...
//   )
//   when(io.stage3Redirect.valid && lastIsMispredict) {
//     update_target(io.stage3Redirect.bits.ftqIdx.value) := io.stage3Redirect.bits.cfiUpdate.target
//   }
