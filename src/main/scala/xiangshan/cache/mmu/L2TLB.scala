...
class L2TLBImp(outer: L2TLB)(implicit p: Parameters) extends PtwModule(outer) with HasCSRConst with HasPerfEvents {
  ...
  if (l2tlbParams.enablePrefetch) {
    ...
    val isWriteL2TlbPrefetchTable = WireInit(Constantin.createRecord(env.FPGAPlatform, "isWriteL2TlbPrefetchTable" + p(XSCoreParamsKey).HartId.toString))
  ...
  val isWriteL1TlbTable = WireInit(Constantin.createRecord(env.FPGAPlatform, "isWriteL1TlbTable" + p(XSCoreParamsKey).HartId.toString))
  ...
  val isWritePageCacheTable = WireInit(Constantin.createRecord(env.FPGAPlatform, "isWritePageCacheTable" + p(XSCoreParamsKey).HartId.toString))
  ...
  val isWritePTWTable = WireInit(Constantin.createRecord(env.FPGAPlatform, "isWritePTWTable" + p(XSCoreParamsKey).HartId.toString))
  ...
  val isWriteL2TlbMissQueueTable = WireInit(Constantin.createRecord(env.FPGAPlatform, "isWriteL2TlbMissQueueTable" + p(XSCoreParamsKey).HartId.toString))
