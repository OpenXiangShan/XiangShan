...
class LoadPipe(id: Int)(implicit p: Parameters) extends DCacheModule with HasPerfEvents with HasL1PrefetchSourceParameter {
  ...
  val table_load = ChiselDB.createTable("LoadTrace" + id.toString + "_hart", new LoadPfDbBundle, basicDB = false, tablePerHart = true)
  ...
  val table_pf = ChiselDB.createTable("LoadPfTrace" + id.toString + "_hart", new LoadPfDbBundle, basicDB = false, tablePerHart = true)
  ...
  val table_miss = ChiselDB.createTable("LoadTraceMiss" + id.toString + "_hart", new LoadPfDbBundle, basicDB = false, tablePerHart = true)
  ...
  val table_mshr = ChiselDB.createTable("LoadPfMshr" + id.toString + "_hart", new LoadPfDbBundle, basicDB = false, tablePerHart = true)
