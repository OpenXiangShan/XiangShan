...
class DCacheImp(outer: DCache) extends LazyModuleImp(outer) with HasDCacheParameters with HasPerfEvents with HasL1PrefetchSourceParameter {
  ...
  logger.info(s"DCacheSets: $DCacheSets")
  logger.info(s"DCacheSetDiv: $DCacheSetDiv")
  logger.info(s"DCacheWays: $DCacheWays")
  logger.info(s"DCacheBanks: $DCacheBanks")
  logger.info(s"DCacheSRAMRowBits: $DCacheSRAMRowBits")
  logger.info(s"DCacheWordOffset: $DCacheWordOffset")
  logger.info(s"DCacheBankOffset: $DCacheBankOffset")
  logger.info(s"DCacheSetOffset: $DCacheSetOffset")
  logger.info(s"DCacheTagOffset: $DCacheTagOffset")
  logger.info(s"DCacheAboveIndexOffset: $DCacheAboveIndexOffset")
  logger.info(s"DCacheMaxPrefetchEntry: $MaxPrefetchEntry")
  logger.info(s"WPUEnable: ${dwpuParam.enWPU}")
  logger.info(s"WPUEnableCfPred: ${dwpuParam.enCfPred}")
  logger.info(s"WPUAlgorithm: ${dwpuParam.algoName}")
  logger.info(s"HasCMO: $HasCMO")
