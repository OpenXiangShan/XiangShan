...
(
  ...
  val vfSchdParams = {
    ...
    SchdBlockParams(Seq(
      IssueBlockParams(Seq(
        ExeUnitParams("FEX0", Seq(VSetRvfWvfCfg), Seq(VfWB(port = 0, 0)), Seq(Seq(VfRD(12, 0)), Seq(VfRD(13, 0)))),
      ), numEntries = IssueQueueSize, numEnq = 2),
      IssueBlockParams(Seq(
      ...
      IssueBlockParams(Seq(
        ExeUnitParams("VEX4", Seq(VfcvtCfg), Seq(VfWB(port = 8, 0), IntWB(port = 10, 0)), Seq(Seq(VfRD(7, 1)), Seq(VfRD(8, 1)), Seq(VfRD(9, 1)), Seq(VfRD(10, 1)), Seq(VfRD(11, 1)))),
      ), numEntries = IssueQueueSize, numEnq = 2),
    ),
