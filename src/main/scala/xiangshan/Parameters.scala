  ...
  val vecSchdParams = {
    ...
    SchdBlockParams(Seq(
      IssueBlockParams(Seq(
        ExeUnitParams(
          "VFEX0",
          Seq(VialuCfg, VfaluCfg, VfmaCfg, VimacCfg, VppuCfg, VipuCfg, VfcvtCfg, VSetRvfWvfCfg, VmoveCfg, VSha256cCfg),
      ...
      IssueBlockParams(Seq(
        ExeUnitParams(
          "VFEX1",
          Seq(VialuCfg, VfaluCfg, VfmaCfg, VfdivCfg, VidivCfg, VSha256msCfg),
