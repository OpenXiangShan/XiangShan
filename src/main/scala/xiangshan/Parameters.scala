...
(
  ...
  val vfSchdParams = {
    ...
    SchdBlockParams(Seq(
      ...
      IssueBlockParams(Seq(
        ExeUnitParams("VFEX4", Seq(VfdivCfg, VidivCfg, VcrypP2Cfg, VcrypP5Cfg, VcrypNPCfg), Seq(VfWB(port = 3, 1), V0WB(port = 3, 1)), Seq(Seq(VfRD(3, 2)), Seq(VfRD(4, 2)), Seq(VfRD(5, 2)), Seq(V0RD(1, 2)), Seq(VlRD(1, 2)))),
