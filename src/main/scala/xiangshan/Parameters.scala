...
(
  ...
  def ISAExtensions = Seq(
    ...
    "shvstvecd", "smaia", "smcsrind", "smdbltrp", "smrnmi", "smstateen", "ss1p13", "ssaia",
    "ssccptr", "sscofpmf", "sscounterenw", "sscsrind", "ssdbltrp", "ssstateen", "ssstrict", "sstc",
    "sstvala", "sstvecd", "ssu64xl", "sv39", "sv48", "svade", "svbare", "svinval", "svpbmt",
    "za64rs", "zba", "zbb", "zbc", "zbkb", "zbkc", "zbkx", "zbs", "zcb", "zcmop", "zfa", "zfh",
    "zfhmin", "zic64b", "zicbom", "zicbop", "zicboz", "ziccif", "zicclsm", "ziccrse", "zicntr",
    "zicond", "zicsr", "zifencei", "zihintpause", "zihpm", "zimop", "zkn", "zknd", "zkne", "zknh",
