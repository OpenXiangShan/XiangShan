...
4. `docs/agents/frontend-debugging.md` when debugging DUT or monitor mismatches, especially around `microbench.bin`, FTQ mapping, resolve payloads, or redirect semantics.
