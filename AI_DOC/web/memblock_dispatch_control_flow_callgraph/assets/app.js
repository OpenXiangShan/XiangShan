    ...
    overview: {
      ...
      stages: [
        ...
        stage("并行接口流", "agent default sequence 并行驱动 DUT 接口并通过 common_data 协同。", [
          ...
          lane("issue", ["scalar_issue_compile_time_layout", "memblock_issue_dispatch_base_sequence::body", "send_issue_cycle", "issue_field_assigner::check_target_futype_fuoptype", "lintsissue_agent_agent_driver::record_dispatch_issue_fire", "issue_queue_scheduler::mark_issue_fire"]),
