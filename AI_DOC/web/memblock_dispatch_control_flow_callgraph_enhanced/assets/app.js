    ...
    issue: {
      ...
      stages: [
        ...
        stage("select", "按优先级、ROB 年龄、pipe 数选择发射候选。", [
          lane("sequence", ["memblock_issue_dispatch_base_sequence::body", "drive_dispatch_issue_loop", "issue_queue_scheduler::has_pending_issue_work", "send_issue_cycle"]),
        ...
        stage("assign/drive/mark", "填 payload、驱动 DUT、更新状态。", [
          ...
          lane("mark", ["mark_fired_items", "memblock_issue_dispatch_base_sequence::port_idx_for_item", "issue_queue_scheduler::mark_issue_fire", "issue_queue_scheduler::mark_issue_fire_already_accepted", "common_data_transaction::mark_issue_snapshot", "common_data_transaction::delete_issue_queue_entry", "common_data_transaction::clear_replay_target_after_fire"]),
