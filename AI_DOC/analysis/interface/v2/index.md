...
|---|---|---|---|---|
| [DCache agent](agents/dcache_agent.md) | `auto_inner_dcache_client_out_a/b/c/d/e`、`user_alias`、`user_vaddr`、`user_needHint`、`echo_isKeyword`、CBO、`b_data[2:1]`、`b_data[0]`、Probe、ProbeAckData、GrantAck、source、sink | MemBlock DCache TileLink client、DCache、CoupledL2 SourceB/SinkA/MainPipe | A/C/E DUT request、B/D responder response | DCache-L2 refill hint 与 L2 flush done flow、L2 内侧 TileLink 请求、权限与回复 flow |
